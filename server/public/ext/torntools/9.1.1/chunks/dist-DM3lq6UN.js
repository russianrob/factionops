import { g as elementBuilder } from "./utilities-DwImhkRX.js";
...
function setInformationRetriever(informationRetriever) {}
//#endregion
...
var root$1 = /* @__PURE__ */ from_html(`<meta name="theme-color"/>`);
...
var root = /* @__PURE__ */ from_html(`<meta name="theme-color"/>`);
...
//#endregion
export { clsx as $, snapshot as $t, setFeatureManager as A, user_effect as At, onMount as B, derived_safe_equal as Bt, DATA_FETCHER as C, createAttachmentKey as Ct, RUNTIME_INFORMATION as D, untrack as Dt, OFFLOAD_SERVICE as E, tick as Et, setScriptInjector as F, sibling as Ft, bind_this as G, store_get as Gt, rest_props as H, createSubscriber as Ht, setStaticItemResolver as I, proxy as It, STYLE as J, getContext as Jt, bind_files as K, writable as Kt, setTTStorage as L, mutable_source as Lt, setOffloadService as M, $window as Mt, setRuntimeInformation as N, child as Nt, setDataFetcher as O, effect_root as Ot, setRuntimeStorage as P, first_child as Pt, set_class as Q, setContext as Qt, ttStorage as R, set as Rt, ttCache as S, on as St, ITEM_RESOLVER as T, get as Tt, spread_props as U, remove_textarea_child as Ut, prop as V, user_derived as Vt, init as W, setup_stores as Wt, set_attribute as X, pop as Xt, attribute_effect as Y, hasContext as Yt, set_style as Z, push as Zt, torndata as _, props_id as _t, BACKGROUND_SERVICE as a, html as at, DEFAULT_STORAGE as b, delegated as bt, cn as c, key as ct, initializeDatabase as d, set_text as dt, next as en, clsx$1 as et, loadDatabase as f, unmount as ft, storageListeners as g, from_svg as gt, settings as h, from_html as ht, exposeDebugObjects as i, snippet as it, setInformationRetriever as j, user_pre_effect as jt, setEventHandler as k, template_effect as kt, api as l, if_block as lt, npcs as m, comment as mt, setMode as n, noop as nn, element as nt, SOURCE_SERVICE as o, each as ot, localdata as p, append as pt, bind_value as q, getAllContexts as qt, derivedMode as r, to_array as rn, component as rt, SvelteMap as s, index as st, Mode_watcher as t, reset as tn, action as tt, factiondata as u, mount as ut, userdata as v, text as vt, EVENT_HANDLER as w, deep_read_state as wt, getDefaultStorage as x, event as xt, version as y, delegate as yt, onDestroy as z, state as zt };

//# sourceMappingURL=dist-DM3lq6UN.js.map