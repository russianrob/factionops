...
import { B as onMount, Ft as sibling, G as bind_this, Gt as store_get, H as rest_props, It as proxy, Kt as writable, Nt as child, Pt as first_child, Q as set_class, R as ttStorage, Rt as set, Tt as get, U as spread_props, V as prop, Vt as user_derived, W as init, Wt as setup_stores, X as set_attribute, Xt as pop, Y as attribute_effect, Zt as push, _t as props_id, a as BACKGROUND_SERVICE, bt as delegated, c as cn, d as initializeDatabase, dt as set_text, en as next, g as storageListeners, gt as from_svg, ht as from_html, i as exposeDebugObjects, it as snippet, jt as user_pre_effect, kt as template_effect, lt as if_block, mt as comment, n as setMode, nn as noop, ot as each, pt as append, rt as component, t as Mode_watcher, tn as reset, tt as action, ut as mount, vt as text$1, yt as delegate, zt as state } from "./dist-DM3lq6UN.js";
import { A as Escape_layer, B as createId, E as Scroll_lock, F as AlertDialogCancelState, Gt as link, L as DialogContentState, N as Portal, O as Text_selection_layer, P as Dialog_title, R as DialogRootState, T as Dialog_overlay, V as noop$1, Vt as formatTime, Wt as Router, _t as afterSleep, d as Badge, f as toast, g as buttonVariants, h as Button, i as active, j as Dismissible_layer, k as Focus_scope, kt as boxWith, l as Sonner_1, m as getIconContext, n as Input, qt as replace, r as registerExtensionContext, s as Tooltip_provider, t as TrashIcon, v as Separator, w as Dialog_description, wt as mergeProps, zt as formatDate } from "./TrashIcon-DJq8vlLE.js";
import { n as Switch, r as Checkbox, t as PlusIcon } from "./PlusIcon-BAdcbwZ6.js";
...
var root$15 = from_html(`<button><!></button>`);
function Alert_dialog_cancel$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), disabled = prop($$props, "disabled", 3, false), restProps = rest_props($$props, rest_excludes$11);
...
var root$13 = from_html(`<li><a class="rounded px-2 py-1 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800"> </a></li>`);
var root_1$6 = from_html(`<div class="flex min-h-screen flex-col"><header class="flex items-center justify-center gap-5 px-5 py-2"><nav><ul class="flex gap-4"></ul></nav> <div class="h-6 w-px bg-gray-300 dark:bg-gray-600"></div> <nav><ul class="flex gap-4"><li><a href="/options.html" target="_blank" rel="noopener noreferrer" class="rounded px-2 py-1 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800">Settings</a></li></ul></nav></header> <!> <main class="mx-auto w-full max-w-6xl p-8"><!></main></div>`);
...
function Alert_dialog_cancel($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), variant = prop($$props, "variant", 3, "outline"), size = prop($$props, "size", 3, "default"), restProps = rest_props($$props, rest_excludes$9);
	var fragment = comment();
	var node = first_child(fragment);
	{
...
function Alert_dialog_overlay($$anchor, $$props) {
	...
	var node = first_child(fragment);
	{
		let $0 = user_derived(() => cn("data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 z-50 bg-black/10 duration-100 supports-backdrop-filter:backdrop-blur-xs", $$props.class));
...
function Alert_dialog_portal($$anchor, $$props) {
	let restProps = rest_props($$props, rest_excludes$7);
	var fragment = comment();
...
function Alert_dialog_content($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), size = prop($$props, "size", 3, "default"), restProps = rest_props($$props, rest_excludes$6);
...
function Alert_dialog_footer($$anchor, $$props) {
	...
	attribute_effect(div, ($0) => ({
		...
		class: $0,
		...restProps
	}), [() => cn("bg-muted/50 -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 sm:flex-row sm:justify-end", $$props.class)]);
	snippet(child(div), () => $$props.children ?? noop);
	reset(div);
...
function Alert_dialog($$anchor, $$props) {
	push($$props, true);
	let open = prop($$props, "open", 15, false), restProps = rest_props($$props, rest_excludes$1);
	var fragment = comment();
...
var root$8 = from_svg(`<path d="M216.49,168.49a12,12,0,0,1-17,0L128,97,56.49,168.49a12,12,0,0,1-17-17l80-80a12,12,0,0,1,17,0l80,80A12,12,0,0,1,216.49,168.49Z"></path>`);
var root_1$5 = from_svg(`<path d="M208,160H48l80-80Z" opacity="0.2"></path><path d="M213.66,154.34l-80-80a8,8,0,0,0-11.32,0l-80,80A8,8,0,0,0,48,168H208a8,8,0,0,0,5.66-13.66ZM67.31,152,128,91.31,188.69,152Z"></path>`, 1);
var root_2$3 = from_svg(`<path d="M215.39,163.06A8,8,0,0,1,208,168H48a8,8,0,0,1-5.66-13.66l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,215.39,163.06Z"></path>`);
var root_3$3 = from_svg(`<path d="M212.24,164.24a6,6,0,0,1-8.48,0L128,88.49,52.24,164.24a6,6,0,0,1-8.48-8.48l80-80a6,6,0,0,1,8.48,0l80,80A6,6,0,0,1,212.24,164.24Z"></path>`);
var root_4$3 = from_svg(`<path d="M213.66,165.66a8,8,0,0,1-11.32,0L128,91.31,53.66,165.66a8,8,0,0,1-11.32-11.32l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,213.66,165.66Z"></path>`);
var root_5$2 = from_svg(`<path d="M210.83,162.83a4,4,0,0,1-5.66,0L128,85.66,50.83,162.83a4,4,0,0,1-5.66-5.66l80-80a4,4,0,0,1,5.66,0l80,80A4,4,0,0,1,210.83,162.83Z"></path>`);
...
var root$7 = from_html(`<span class="flex items-center justify-center"><!></span>`);
var root_1$4 = from_html(`<button class="hover:text-primary flex items-center gap-0.5 leading-none font-medium disabled:pointer-events-none" type="button"><!> <!></button>`);
var root_2$2 = from_html(`<a class="hover:underline" target="_blank" rel="noreferrer"> </a>`);
var root_3$2 = from_html(`<!> <!>`, 1);
var root_4$2 = from_html(`<div class="bg-card overflow-hidden rounded-sm border"><!></div>`);
...
var root$6 = from_html(`<div class="space-y-2"><div class="flex flex-wrap items-center justify-between gap-2"><div><h1 class="text-2xl font-bold">Attack History</h1> <p class="text-muted-foreground text-sm"> </p></div> <div class="flex items-center gap-2"><label class="flex items-center gap-2 text-sm"><!> <span>Show percentages</span></label> <!></div></div> <!></div>`);
...
var root$4 = from_html(`<a class="hover:underline" target="_blank" rel="noreferrer"> </a>`);
var root_1$3 = from_html(`<span class="text-muted-foreground"> </span>`);
var root_2$1 = from_html(`<span> </span>`);
var root_3$1 = from_html(`<span class="text-muted-foreground">N/A</span>`);
var root_4$1 = from_html(`<div class="grid grid-cols-2 gap-x-2 gap-y-0.5"><label class="flex items-center gap-1 text-xs"><span>chain reaches</span> <!></label> <label class="flex items-center gap-1 text-xs"><span>members drop below</span> <!></label> <!> <!> <!></div>`);
var root_5$1 = from_html(`<!> <!>`, 1);
var root_6$1 = from_html(`<div class="bg-card overflow-hidden rounded-lg border"><!></div>`);
...
var root$3 = from_html(`<!> Add`, 1);
var root_1$2 = from_html(`<div class="space-y-2"><div class="flex flex-wrap items-center justify-between gap-2"><div><h1 class="text-2xl font-bold">Faction Stakeouts</h1> <p class="text-muted-foreground text-sm"> </p></div> <div class="flex flex-wrap items-center gap-2"><!> <!> <!></div></div> <!></div>`);
...
var root$1 = from_html(`<a class="hover:underline" target="_blank" rel="noreferrer"> </a>`);
var root_1$1 = from_html(`<span class="text-muted-foreground"> </span>`);
var root_2 = from_html(`<span class="flex items-center gap-1.5 rounded-full px-2 py-0.5 text-xs"><span></span> </span>`);
var root_3 = from_html(`<div><!></div>`);
var root_4 = from_html(`<div class="grid grid-cols-2 gap-x-2 gap-y-0.5"><!> <!> <!> <!> <!> <label class="flex items-center gap-1 text-xs"><span>life drops below</span> <!> <span>%</span></label> <label class="flex items-center gap-1 text-xs"><span>offline over</span> <!> <span>hours</span></label> <!></div>`);
var root_5 = from_html(`<!> <!>`, 1);
var root_6 = from_html(`<div class="bg-card overflow-hidden rounded-lg border"><!></div>`);
														...
														Table_Cell($$anchor, {
															...
															children: ($$anchor, $$slotProps) => {
																...
																var consequent_9 = ($$anchor) => {
																	...
																	{
																		let $0 = user_derived(() => `flying-${get(row).id}`);
																		AlertCheckbox(node_17, {
																			...
																			label: "is flying",
																			get checked() {
																				return get(row).alerts.flying;
																			},
																			onchange: (value) => $$props.onBooleanAlertChange(get(row).id, "flying", value)
																		});
																	}
																	...
																	var label = sibling(node_19, 2);
																	var node_20 = sibling(child(label), 2);
																	{
																	...
																	reset(label);
																	var label_1 = sibling(label, 2);
																	var node_21 = sibling(child(label_1), 2);
																	{
																	...
																	next(2);
																	reset(label_1);
																	var node_22 = sibling(label_1, 2);
																	{
																		let $0 = user_derived(() => `revivable-${get(row).id}`);
																		AlertCheckbox(node_22, {
																			get id() {
																				return get($0);
																			},
																			label: "is revivable",
...
var root = from_html(`<!> Add`, 1);
var root_1 = from_html(`<div class="space-y-2"><div class="flex flex-wrap items-center justify-between gap-2"><div><h1 class="text-2xl font-bold">Stakeouts</h1> <p class="text-muted-foreground text-sm"> </p></div> <div class="flex flex-wrap items-center gap-2"><!> <!> <!></div></div> <!></div>`);
...
//# sourceMappingURL=targets-lUyy54f-.js.map