import { c as isNumber, g as elementBuilder, j as browser, l as isSpeechSynthesisAvailable, m as toClipboard, r as TO_MILLIS, t as MONTHS } from "./utilities-DwImhkRX.js";
import { $ as clsx, At as user_effect, B as onMount, Bt as derived_safe_equal, Dt as untrack, Ft as sibling, G as bind_this, Gt as store_get, H as rest_props, It as proxy, Kt as writable, Lt as mutable_source, Mt as $window, Nt as child, Pt as first_child, Q as set_class, R as ttStorage, Rt as set, St as on, Tt as get, U as spread_props, V as prop, Vt as user_derived, W as init, Wt as setup_stores, X as set_attribute, Xt as pop, Y as attribute_effect, Z as set_style, Zt as push, _t as props_id, a as BACKGROUND_SERVICE, at as html, bt as delegated, c as cn, d as initializeDatabase, dt as set_text, en as next$1, f as loadDatabase, g as storageListeners, gt as from_svg, ht as from_html, i as exposeDebugObjects, it as snippet, jt as user_pre_effect, kt as template_effect, lt as if_block, mt as comment, n as setMode, nn as noop, ot as each, pt as append, rn as to_array, rt as component, st as index, t as Mode_watcher, tn as reset, tt as action, ut as mount, v as userdata, vt as text, wt as deep_read_state, xt as event, yt as delegate, z as onDestroy, zt as state } from "./dist-DM3lq6UN.js";
import { At as isBox, B as createId, Bt as formatNumber, C as getFloatingContentCSSVars, Dt as boxFlatten, Et as BoxSymbol, Ft as capitalizeText, G as isIOS, Gt as link, H as PresenceManager, It as daySuffix, J as ARROW_RIGHT, Jt as router, K as ARROW_DOWN, Kt as push$1, Mt as isWritableSymbol, N as Portal, Nt as toReadonlyBox, Ot as boxFrom, Rt as formatBytes, S as FloatingAnchorState, St as Context, Tt as executeCallbacks, U as isElementOrSVGElement, Ut as hasAPIData, V as noop$1, Vt as formatTime, W as isHTMLElement, Wt as Router, Y as ARROW_UP, _ as tv, _t as afterSleep, a as Tooltip, at as boolToEmptyStrOrUndef, b as Popper_layer, bt as Previous, c as Tooltip_content, ct as boolToTrueOrUndef, d as Badge, et as HOME, f as toast, ft as getDataOpenClosed, gt as afterTick, h as Button, ht as DOMContext, i as active, jt as isWritableBox, kt as boxWith, l as Sonner_1, lt as createBitsAttrs, m as getIconContext, mt as attachRef, n as Input, nt as PAGE_DOWN, o as Tooltip_trigger, ot as boolToStr, pt as getDataTransitionAttrs, q as ARROW_LEFT, qt as replace, r as registerExtensionContext, rt as PAGE_UP, s as Tooltip_provider, st as boolToStrTrueOrUndef, t as TrashIcon, u as Check, ut as getAriaChecked, v as Separator, vt as onMountEffect, wt as mergeProps, x as Floating_layer, xt as watch, y as Popper_layer_force_mount, yt as onDestroyEffect, zt as formatDate } from "./TrashIcon-DJq8vlLE.js";
import { A as ALL_AREAS, C as Dialog_title, D as Dialog_content, E as Dialog_description, F as HIGHLIGHT_PLACEHOLDERS, L as TORNTOOLS_FORUM_POST, M as CASINO_GAMES, N as CHAT_TITLE_COLORS, O as Textarea, P as CUSTOM_LINKS_PRESET, S as Dialog_trigger, T as Dialog_footer, _ as Card_description, b as fetchData, c as Command_group, d as MagnifyingGlassIcon, f as changeAPIKey, g as Card_header, h as Card_title, i as Command_input, j as ALL_ICONS, k as Spinner, l as Command_empty, m as Card, n as Command_list, p as checkAPIPermission, r as Command_item, u as Command, v as Card_content, w as Dialog_header, x as Dialog, y as FETCH_PLATFORMS } from "./command-DIy3eOEG.js";
import { i as Hidden_input, n as Switch, r as Checkbox, t as PlusIcon } from "./PlusIcon-BAdcbwZ6.js";
...
var root$111 = from_html(`<kbd><!></kbd>`);
function Kbd_group($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$46);
	var kbd = root$111();
...
var root$110 = from_html(`<kbd><!></kbd>`);
function Kbd($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$45);
	var kbd = root$110();
	attribute_effect(kbd, ($0) => ({
		"data-slot": "kbd",
		class: $0,
...
var root$109 = from_html(`<div><!></div>`);
function Accordion$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let disabled = prop($$props, "disabled", 3, false), value = prop($$props, "value", 15), ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), onValueChange = prop($$props, "onValueChange", 3, noop$1), loop = prop($$props, "loop", 3, true), orientation = prop($$props, "orientation", 3, "vertical"), restProps = rest_props($$props, rest_excludes$44);
...
var root$108 = from_html(`<div><!></div>`);
function Accordion_item$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	const defaultId = createId(uid);
	let id = prop($$props, "id", 3, defaultId), disabled = prop($$props, "disabled", 3, false), value = prop($$props, "value", 3, defaultId), ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$43);
...
var root$107 = from_html(`<div><!></div>`);
function Accordion_header($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), level = prop($$props, "level", 3, 2), ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$42);
...
var root$106 = from_html(`<button><!></button>`);
function Accordion_trigger$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let disabled = prop($$props, "disabled", 3, false), ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), tabindex = prop($$props, "tabindex", 3, 0), restProps = rest_props($$props, rest_excludes$41);
...
var root$105 = from_html(`<div><!></div>`);
function Accordion_content$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), forceMount = prop($$props, "forceMount", 3, false), hiddenUntilFound = prop($$props, "hiddenUntilFound", 3, false), restProps = rest_props($$props, rest_excludes$40);
...
var root$104 = from_html(`<div><div><!></div></div>`);
...
var root$103 = from_html(`<div><!></div>`);
var root_1$63 = from_html(`<!> <!>`, 1);
function Select_item$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), label = prop($$props, "label", 19, () => $$props.value), disabled = prop($$props, "disabled", 3, false), onHighlight = prop($$props, "onHighlight", 3, noop$1), onUnhighlight = prop($$props, "onUnhighlight", 3, noop$1), restProps = rest_props($$props, rest_excludes$38);
...
var root$102 = from_html(`<div><!></div>`);
function Select_viewport($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$37);
...
var root$101 = from_html(`<div><!></div>`);
var root_1$62 = from_html(`<!> <!>`, 1);
function Select_scroll_down_button$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), delay = prop($$props, "delay", 3, () => 50), restProps = rest_props($$props, rest_excludes$36);
...
var root$100 = from_html(`<div><!></div>`);
var root_1$61 = from_html(`<!> <!>`, 1);
function Select_scroll_up_button$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), delay = prop($$props, "delay", 3, () => 50), restProps = rest_props($$props, rest_excludes$35);
...
var root$99 = from_html(`<label><!></label>`);
...
var root$98 = from_html(`<div><!></div>`);
var root_1$60 = from_html(`<!> <!>`, 1);
...
var root$97 = from_html(`<button><!></button>`);
function Radio_group_item$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), disabled = prop($$props, "disabled", 3, false), ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$32);
...
var root$95 = from_html(`<button><!></button>`);
function Select_trigger$1($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), type = prop($$props, "type", 3, "button"), restProps = rest_props($$props, rest_excludes$31);
...
var root$94 = from_html(`<span><!></span>`);
...
var root$93 = from_html(`<span><!></span>`);
function Slider_range($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), restProps = rest_props($$props, rest_excludes$29);
...
var root$92 = from_html(`<span><!></span>`);
function Slider_thumb($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), disabled = prop($$props, "disabled", 3, false), restProps = rest_props($$props, rest_excludes$28);
...
var root$91 = from_html(`<a class="text-primary underline-offset-1 hover:underline" target="_blank" rel="noreferrer"><!></a>`);
...
var root$90 = from_html(`<!> <!>`, 1);
var root_1$59 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Contact</h2> <div class="mt-2 space-y-1"><p>Our source code is available on <!> and licensed under the GNU General Public Licence. Our terms of service can be found <!>.</p> <p>We can be contacted through our <!> or <!>.</p> <!> <div><p>Suggestions and bug reports are important to keep improving TornTools. When reporting a bug, include:</p> <ul class="text-muted-foreground mt-1 list-disc pl-4"><li>Screenshots of the bug in action.</li> <li>Screenshots of the console output. <ul class="list-disc pl-4"><li>Console access via <!> , or right click -> inspect -> console.</li></ul></li></ul></div></div></section>`);
function Contact($$anchor) {
	var section = root_1$59();
...
var root$89 = from_html(`<a class="text-primary text-lg font-bold underline-offset-2 hover:underline" target="_blank" rel="noreferrer"> </a>`);
var root_1$58 = from_html(`<p class="text-primary text-lg font-bold"> </p>`);
var root_2$49 = from_html(`<a class="underline-offset-1 hover:underline" target="_blank" rel="noreferrer"> </a>`);
var root_3$33 = from_html(`<div class="flex flex-col gap-0.5"></div>`);
var root_4$21 = from_html(`<div class="border-border rounded-lg border p-2"><!> <p class="text-muted-foreground"> </p> <!> <!></div>`);
var root_5$16 = from_html(`<div class="grid grid-cols-2 gap-2 lg:grid-cols-4"></div>`);
...
var root$88 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Team</h2> <p class="text-muted-foreground text-sm">TornTools is free to use but if you feel like giving back to the developers then feel free to donate in-game or via one of the donation links.</p> <div class="my-2"><!></div> <p class="text-muted-foreground text-sm">and everyone else who contributed to our codebase, helped us beta-test, provided feedback, suggestions and bug reports, or just generally helped out in
		the Discord.</p></section>`);
...
var root$87 = from_html(`<article><p class="border-border rounded-lg border p-2 text-sm"><strong class="text-sm"> </strong> <span> </span></p></article>`);
...
var root$86 = from_html(`<div class="mt-2 grid gap-3 md:grid-cols-2"></div>`);
var root_1$57 = from_html(`<p class="text-muted-foreground mt-2 text-sm">Data health checks are not relevant without an API key configured.</p>`);
var root_2$48 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Data health</h2> <!></section>`);
...
var root$85 = from_html(`<span> </span> <!>`, 1);
function MaintenanceActionButton($$anchor, $$props) {
	...
	Button($$anchor, {
		...
		class: "relative w-full cursor-pointer justify-center",
		onclick: handleClick,
		children: ($$anchor, $$slotProps) => {
			var fragment_1 = root$85();
...
var root$84 = from_html(`<div class="grid gap-2 sm:grid-cols-2"><!> <!> <!> <!></div>`);
var root_1$56 = from_html(`<p class="text-muted-foreground text-sm">Data health checks are not relevant without an API key configured.</p>`);
var root_2$47 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Maintenance</h2> <div class="mt-2 grid gap-4 lg:grid-cols-[2fr_1fr]"><section class="space-y-2"><h3 class="text-sm font-bold">Force update</h3> <!></section> <section class="space-y-2"><h3 class="text-sm font-bold">Other</h3> <div class="grid gap-2"><!> <!></div></section></div></section>`);
function MaintenanceButtons($$anchor, $$props) {
	push($$props, true);
	const $apiStore = () => store_get(apiStore, "$apiStore", $$stores);
	const [$$stores, $$cleanup] = setup_stores();
	const hasApiKey = user_derived(() => !!$apiStore()?.torn?.key);
	var section = root_2$47();
	var div = sibling(child(section), 2);
...
var root$83 = from_html(`<span class="font-medium"> </span>`);
var root_1$55 = from_html(`<span> </span>`);
var root_2$46 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Version</h2> <div class="mt-2 space-y-2 text-sm"><p>Version: <span class="font-medium"> </span></p> <p class="flex items-center gap-1">Disk space used: <!></p></div></section>`);
...
var root$82 = from_html(`<section class="space-y-4"><!> <!> <!> <!> <!></section>`);
...
var root$81 = from_html(`<div><!></div>`);
function Accordion_content($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$27);
	var fragment = comment();
	component(first_child(fragment), () => Accordion_content$1, ($$anchor, AccordionPrimitive_Content) => {
		AccordionPrimitive_Content($$anchor, spread_props({
			...
			children: ($$anchor, $$slotProps) => {
				...
				snippet(child(div), () => $$props.children ?? noop);
				reset(div);
				template_effect(($0) => set_class(div, 1, $0), [() => clsx(cn("[&_a]:hover:text-foreground pt-0 pb-2.5 [&_a]:underline [&_a]:underline-offset-3 [&_p:not(:last-child)]:mb-4", $$props.class))]);
				append($$anchor, div);
			},
			$$slots: { default: true }
		}));
...
function Accordion_item($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$26);
	var fragment = comment();
	var node = first_child(fragment);
	{
...
var root$80 = from_svg(`<path d="M216.49,104.49l-80,80a12,12,0,0,1-17,0l-80-80a12,12,0,0,1,17-17L128,159l71.51-71.52a12,12,0,0,1,17,17Z"></path>`);
var root_1$54 = from_svg(`<path d="M208,96l-80,80L48,96Z" opacity="0.2"></path><path d="M215.39,92.94A8,8,0,0,0,208,88H48a8,8,0,0,0-5.66,13.66l80,80a8,8,0,0,0,11.32,0l80-80A8,8,0,0,0,215.39,92.94ZM128,164.69,67.31,104H188.69Z"></path>`, 1);
var root_2$45 = from_svg(`<path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,48,88H208a8,8,0,0,1,5.66,13.66Z"></path>`);
var root_3$32 = from_svg(`<path d="M212.24,100.24l-80,80a6,6,0,0,1-8.48,0l-80-80a6,6,0,0,1,8.48-8.48L128,167.51l75.76-75.75a6,6,0,0,1,8.48,8.48Z"></path>`);
var root_4$20 = from_svg(`<path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>`);
var root_5$15 = from_svg(`<path d="M210.83,98.83l-80,80a4,4,0,0,1-5.66,0l-80-80a4,4,0,0,1,5.66-5.66L128,170.34l77.17-77.17a4,4,0,1,1,5.66,5.66Z"></path>`);
var root_6$13 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function CaretDown($$anchor, $$props) {
	push($$props, true);
	const ctx = getIconContext();
	let props = rest_props($$props, rest_excludes$25);
	...
	var node_2 = sibling(node, 2);
	var consequent_1 = ($$anchor) => {
		append($$anchor, root$80());
	};
	var consequent_2 = ($$anchor) => {
		var fragment_1 = root_1$54();
		next$1();
		append($$anchor, fragment_1);
	};
	var consequent_3 = ($$anchor) => {
	...
	var alternate = ($$anchor) => {
		var text$37 = text();
		text$37.nodeValue = (console.error("Unsupported icon weight. Choose from \"thin\", \"light\", \"regular\", \"bold\", \"fill\", or \"duotone\"."), "");
		append($$anchor, text$37);
	};
	if_block(node_2, ($$render) => {
...
var root$79 = from_svg(`<path d="M216.49,168.49a12,12,0,0,1-17,0L128,97,56.49,168.49a12,12,0,0,1-17-17l80-80a12,12,0,0,1,17,0l80,80A12,12,0,0,1,216.49,168.49Z"></path>`);
var root_1$53 = from_svg(`<path d="M208,160H48l80-80Z" opacity="0.2"></path><path d="M213.66,154.34l-80-80a8,8,0,0,0-11.32,0l-80,80A8,8,0,0,0,48,168H208a8,8,0,0,0,5.66-13.66ZM67.31,152,128,91.31,188.69,152Z"></path>`, 1);
var root_2$44 = from_svg(`<path d="M215.39,163.06A8,8,0,0,1,208,168H48a8,8,0,0,1-5.66-13.66l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,215.39,163.06Z"></path>`);
var root_3$31 = from_svg(`<path d="M212.24,164.24a6,6,0,0,1-8.48,0L128,88.49,52.24,164.24a6,6,0,0,1-8.48-8.48l80-80a6,6,0,0,1,8.48,0l80,80A6,6,0,0,1,212.24,164.24Z"></path>`);
var root_4$19 = from_svg(`<path d="M213.66,165.66a8,8,0,0,1-11.32,0L128,91.31,53.66,165.66a8,8,0,0,1-11.32-11.32l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,213.66,165.66Z"></path>`);
var root_5$14 = from_svg(`<path d="M210.83,162.83a4,4,0,0,1-5.66,0L128,85.66,50.83,162.83a4,4,0,0,1-5.66-5.66l80-80a4,4,0,0,1,5.66,0l80,80A4,4,0,0,1,210.83,162.83Z"></path>`);
var root_6$12 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function CaretUp($$anchor, $$props) {
	push($$props, true);
	const ctx = getIconContext();
	let props = rest_props($$props, rest_excludes$24);
	let weight = user_derived(() => $$props.weight ?? ctx.weight ?? "regular");
	let color = user_derived(() => $$props.color ?? ctx.color ?? "currentColor");
	let size = user_derived(() => $$props.size ?? ctx.size ?? "1em");
	let mirrored = user_derived(() => $$props.mirrored ?? ctx.mirrored ?? false);
	...
	var node_2 = sibling(node, 2);
	var consequent_1 = ($$anchor) => {
		append($$anchor, root$79());
	};
	var consequent_2 = ($$anchor) => {
		var fragment_1 = root_1$53();
		next$1();
		append($$anchor, fragment_1);
	};
	var consequent_3 = ($$anchor) => {
	...
	var alternate = ($$anchor) => {
		var text$36 = text();
		text$36.nodeValue = (console.error("Unsupported icon weight. Choose from \"thin\", \"light\", \"regular\", \"bold\", \"fill\", or \"duotone\"."), "");
		append($$anchor, text$36);
	};
	if_block(node_2, ($$render) => {
		if (get(weight) === "bold") $$render(consequent_1);
		else if (get(weight) === "duotone") $$render(consequent_2, 1);
...
var root$78 = from_html(`<!> <!> <!>`, 1);
function Accordion_trigger($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), level = prop($$props, "level", 3, 3), restProps = rest_props($$props, rest_excludes$23);
	var fragment = comment();
...
function Accordion($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), value = prop($$props, "value", 15), restProps = rest_props($$props, rest_excludes$22);
	var fragment = comment();
	var node = first_child(fragment);
	{
...
var root$77 = from_html(`<div class="ml-4"><span class="flex items-center before:mr-1 before:inline-block before:h-2 before:w-2 before:rounded-full before:border-2 before:border-(--contributor-color) before:bg-(--contributor-color) before:align-middle before:content-['']"></span></div>`);
var root_1$52 = from_html(`<div class="mx-6 mb-2"><h3 class="font-bold"> </h3> <!></div>`);
...
var root$76 = from_html(`<a target="_blank" rel="noopener noreferrer" class="flex items-center before:mr-1 before:inline-block before:h-2 before:w-2 before:rounded-full before:border-2 before:border-(--contributor-color) before:bg-(--contributor-color) before:align-middle before:content-['']"> </a>`);
var root_1$51 = from_html(`<span class="flex items-center before:mr-1 before:inline-block before:h-2 before:w-2 before:rounded-full before:border-2 before:border-(--contributor-color) before:bg-(--contributor-color) before:align-middle before:content-['']"> </span>`);
var root_2$43 = from_html(`<div class="ml-4"><!></div>`);
var root_3$30 = from_html(`<div class="mx-6 mb-2"><h3 class="font-bold">Contributors</h3> <!></div>`);
...
var root$75 = from_html(` <!>`, 1);
var root_1$50 = from_html(`<!> <!>`, 1);
function Changelog($$anchor, $$props) {
	...
	init();
	{
		let $0 = derived_safe_equal(() => [changelog[0].version]);
		Accordion($$anchor, {
			type: "multiple",
			class: "gap-2",
			get value() {
						...
						children: ($$anchor, $$slotProps) => {
							...
							var node_1 = first_child(fragment_3);
							{
								...
								Accordion_trigger(node_1, {
									...
									children: ($$anchor, $$slotProps) => {
										next$1();
										var fragment_4 = root$75();
										var text$35 = first_child(fragment_4);
										var node_2 = sibling(text$35);
										var consequent = ($$anchor) => {
											Badge($$anchor, {
												variant: "secondary",
												class: "ml-1",
										...
										template_effect(() => set_text(text$35, `${get(entry).title ?? ""} `));
										append($$anchor, fragment_4);
									},
									$$slots: { default: true }
								});
...
async function getExportData(includeApi, isFileExport = false) {
	const exportedKeys = Array.from(LOCAL_EXPORT_KEYS);
	if (includeApi) exportedKeys.unshift("api");
	let values;
	const corrupted = [];
	try {
		values = await ttStorage.get(exportedKeys);
	} catch {
		values = [];
		for (const key of exportedKeys) try {
	...
	values.filter((value) => !isNumber(value)).forEach((value, index) => {
		...
		if (corrupted.includes(key) && isFileExport) database[`${key}-corrupted`] = null;
...
var root$74 = from_html(`<!> <!>`, 1);
var root_1$49 = from_html(`<label class="border-border flex items-start gap-2 rounded-lg border p-2 text-sm"><!> <span><span class="block font-medium">Include API key</span></span></label>`);
var root_2$42 = from_html(`<!> <div class="space-y-3"><div class="border-border bg-muted/30 rounded-lg border p-3 text-sm"><h3 class="font-medium">Includes:</h3> <ul class="text-muted-foreground mt-2 list-disc space-y-0.5 pl-5"><li>User ID and username</li> <li>Client version and database size</li> <li>Export date and time</li> <li>Version notice</li> <li>Preferences</li> <li>Filters and sorting</li> <li>Stakeouts, notes and quick items</li></ul></div> <!> <!></div> <!>`, 1);
...
var root$73 = from_html(`<!> <!>`, 1);
var root_1$48 = from_html(`<li>API Key (if present in the export)</li>`);
var root_2$41 = from_html(`<!> <div class="space-y-3"><!> <div class="border-border bg-muted/30 rounded-lg border p-3 text-sm"><h3 class="font-medium">Following items will be overwritten:</h3> <ul class="text-muted-foreground mt-2 list-disc space-y-0.5 pl-5"><li>Version notice</li> <li>Preferences</li> <li>Filters and sorting</li> <li>Stakeouts</li> <li>Notes</li> <li>Quick Items, crimes and jail bust / bail</li> <!></ul></div></div> <!>`, 1);
...
var root$72 = from_html(`<article class="border-border flex h-full flex-col rounded-lg border p-2"><div class="flex flex-wrap items-center gap-2"><h3 class="text-sm font-bold"> </h3> <!></div> <p class="text-muted-foreground mt-1 text-sm"> </p> <!> <div class="mt-auto flex flex-wrap gap-2 pt-2"><!> <!> <!></div></article> <!> <!>`, 1);
...
var root$71 = from_html(`<input class="hidden" type="file" accept=".json,application/json"/> <!>`, 1);
function FileMethod($$anchor, $$props) {
	...
	async function exportData(includeApi) {
		...
		elementBuilder({
			type: "a",
			href: url,
			attributes: { download: exportData.corrupted?.length ? "torntools-corrupted.json" : "torntools.json" }
		}).click();
			...
			children: ($$anchor, $$slotProps) => {
				...
				component(first_child(fragment_1), () => Dialog_content, ($$anchor, Dialog_Content) => {
					Dialog_Content($$anchor, {
						class: "sm:max-w-md",
						children: ($$anchor, $$slotProps) => {
							var fragment_2 = root$70();
							var node_2 = first_child(fragment_2);
							component(node_2, () => Dialog_header, ($$anchor, Dialog_Header) => {
								Dialog_Header($$anchor, {
									children: ($$anchor, $$slotProps) => {
										var fragment_3 = root$70();
										var node_3 = first_child(fragment_3);
										component(node_3, () => Dialog_title, ($$anchor, Dialog_Title) => {
											Dialog_Title($$anchor, {
												children: ($$anchor, $$slotProps) => {
...
var root$69 = from_html(`<p class="text-muted-foreground flex items-center gap-1"><!> Loading sync status...</p>`);
var root_1$47 = from_html(`<p>Last update: <span class="font-medium"> </span></p> <p>Version: <span class="font-medium"> </span></p> <p>Database size: <span class="font-medium"> </span></p>`, 1);
var root_2$40 = from_html(`<p class="text-muted-foreground"> </p>`);
var root_3$29 = from_html(`<div class="mt-1 text-xs"><!></div>`);
...
var root$68 = from_html(`<div class="rounded-lg border border-amber-300 bg-amber-50 p-3 text-sm text-amber-950 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-100"> </div>`);
var root_1$46 = from_html(`<!> <!>`, 1);
	...
	var node = first_child(fragment);
	{
		...
		const exportWarning = ($$anchor) => {
			...
			var consequent = ($$anchor) => {
				...
				reset(div);
				template_effect(($0) => set_text(text_1, `Your custom notification sound is larger than ${$0 ?? ""} and will not be included in the browser sync export.`), [() => formatBytes(REMOTE_SYNC_SOUND_CUSTOM_LIMIT)]);
				append($$anchor, div);
			};
			if_block(node_1, ($$render) => {
...
var root$67 = from_html(`<section class="space-y-4"><section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Locally</h2> <div class="mt-2 grid gap-2 sm:grid-cols-2"><!> <!></div></section> <section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Remote</h2> <div class="mt-2 grid gap-2 sm:grid-cols-2"><!></div></section></section>`);
...
var root$66 = from_html(`<li><a class="rounded px-2 py-1 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800"> </a></li>`);
var root_1$45 = from_html(`<div class="flex min-h-screen flex-col"><header class="flex items-center justify-center gap-5 px-5 py-2"><nav><ul class="flex gap-4"></ul></nav> <div class="h-6 w-px bg-gray-300 dark:bg-gray-600"></div> <nav><ul class="flex gap-4"><li><a href="/targets.html" target="_blank" rel="noopener noreferrer" class="rounded px-2 py-1 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800">Targets</a></li></ul></nav></header> <!> <main class="mx-auto w-full max-w-5xl p-8"><!></main></div>`);
...
var root$65 = from_html(`<div><!> <!></div> <!>`, 1);
var root_1$44 = from_html(`<!> <!>`, 1);
	...
	var node = first_child(fragment);
	{
		...
		component(node, () => Card, ($$anchor, Card_Root) => {
			Card_Root($$anchor, {
				...
				children: ($$anchor, $$slotProps) => {
					var fragment_1 = root_1$44();
					var node_1 = first_child(fragment_1);
					component(node_1, () => Card_header, ($$anchor, Card_Header) => {
						Card_Header($$anchor, {
							class: "flex justify-between gap-3 px-3",
							children: ($$anchor, $$slotProps) => {
								var fragment_2 = root$65();
									...
									component(first_child(fragment_3), () => Card_title, ($$anchor, Card_Title) => {
										Card_Title($$anchor, {
											children: ($$anchor, $$slotProps) => {
												next$1();
												var text$29 = text();
												template_effect(() => set_text(text$29, $$props.title));
												append($$anchor, text$29);
											},
											$$slots: { default: true }
										});
									});
...
function Field_content($$anchor, $$props) {
	...
	attribute_effect(div, ($0) => ({
		...
		class: $0,
		...restProps
	}), [() => cn("group/field-content flex flex-1 flex-col gap-0.5 leading-snug", $$props.class)]);
	snippet(child(div), () => $$props.children ?? noop);
	reset(div);
...
function Label($$anchor, $$props) {
	...
	var node = first_child(fragment);
	{
		let $0 = user_derived(() => cn("flex items-center gap-2 text-sm leading-none font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50", $$props.class));
...
function Field_label($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$18);
	{
		let $0 = user_derived(() => cn("has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 group/field-label peer/field-label flex w-fit gap-2 leading-snug leading-snug group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5", "has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col", $$props.class));
...
var root$62 = from_html(`<div><!></div>`);
function Field($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), orientation = prop($$props, "orientation", 3, "vertical"), restProps = rest_props($$props, rest_excludes$17);
	var div = root$62();
	attribute_effect(div, ($0) => ({
		role: "group",
		"data-slot": "field",
...
var root$61 = from_svg(`<path d="M228,104a12,12,0,0,1-24,0V69l-59.51,59.51a12,12,0,0,1-17-17L187,52H152a12,12,0,0,1,0-24h64a12,12,0,0,1,12,12Zm-44,24a12,12,0,0,0-12,12v64H52V84h64a12,12,0,0,0,0-24H48A20,20,0,0,0,28,80V208a20,20,0,0,0,20,20H176a20,20,0,0,0,20-20V140A12,12,0,0,0,184,128Z"></path>`);
var root_1$43 = from_svg(`<path d="M184,80V208a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V80a8,8,0,0,1,8-8H176A8,8,0,0,1,184,80Z" opacity="0.2"></path><path d="M224,104a8,8,0,0,1-16,0V59.32l-66.33,66.34a8,8,0,0,1-11.32-11.32L196.68,48H152a8,8,0,0,1,0-16h64a8,8,0,0,1,8,8Zm-40,24a8,8,0,0,0-8,8v72H48V80h72a8,8,0,0,0,0-16H48A16,16,0,0,0,32,80V208a16,16,0,0,0,16,16H176a16,16,0,0,0,16-16V136A8,8,0,0,0,184,128Z"></path>`, 1);
var root_2$38 = from_svg(`<path d="M192,136v72a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V80A16,16,0,0,1,48,64h72a8,8,0,0,1,0,16H48V208H176V136a8,8,0,0,1,16,0Zm32-96a8,8,0,0,0-8-8H152a8,8,0,0,0-5.66,13.66L172.69,72l-42.35,42.34a8,8,0,0,0,11.32,11.32L184,83.31l26.34,26.35A8,8,0,0,0,224,104Z"></path>`);
var root_3$28 = from_svg(`<path d="M222,104a6,6,0,0,1-12,0V54.49l-69.75,69.75a6,6,0,0,1-8.48-8.48L201.51,46H152a6,6,0,0,1,0-12h64a6,6,0,0,1,6,6Zm-38,26a6,6,0,0,0-6,6v72a2,2,0,0,1-2,2H48a2,2,0,0,1-2-2V80a2,2,0,0,1,2-2h72a6,6,0,0,0,0-12H48A14,14,0,0,0,34,80V208a14,14,0,0,0,14,14H176a14,14,0,0,0,14-14V136A6,6,0,0,0,184,130Z"></path>`);
var root_4$18 = from_svg(`<path d="M224,104a8,8,0,0,1-16,0V59.32l-66.33,66.34a8,8,0,0,1-11.32-11.32L196.68,48H152a8,8,0,0,1,0-16h64a8,8,0,0,1,8,8Zm-40,24a8,8,0,0,0-8,8v72H48V80h72a8,8,0,0,0,0-16H48A16,16,0,0,0,32,80V208a16,16,0,0,0,16,16H176a16,16,0,0,0,16-16V136A8,8,0,0,0,184,128Z"></path>`);
var root_5$13 = from_svg(`<path d="M220,104a4,4,0,0,1-8,0V49.66l-73.16,73.17a4,4,0,0,1-5.66-5.66L206.34,44H152a4,4,0,0,1,0-8h64a4,4,0,0,1,4,4Zm-36,28a4,4,0,0,0-4,4v72a4,4,0,0,1-4,4H48a4,4,0,0,1-4-4V80a4,4,0,0,1,4-4h72a4,4,0,0,0,0-8H48A12,12,0,0,0,36,80V208a12,12,0,0,0,12,12H176a12,12,0,0,0,12-12V136A4,4,0,0,0,184,132Z"></path>`);
var root_6$11 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function ArrowSquareOutIcon($$anchor, $$props) {
	push($$props, true);
	const ctx = getIconContext();
	let props = rest_props($$props, rest_excludes$16);
	let weight = user_derived(() => $$props.weight ?? ctx.weight ?? "regular");
	let color = user_derived(() => $$props.color ?? ctx.color ?? "currentColor");
	let size = user_derived(() => $$props.size ?? ctx.size ?? "1em");
	let mirrored = user_derived(() => $$props.mirrored ?? ctx.mirrored ?? false);
	...
	var consequent_3 = ($$anchor) => {
		append($$anchor, root_2$38());
	};
	var consequent_4 = ($$anchor) => {
		append($$anchor, root_3$28());
	};
	var consequent_5 = ($$anchor) => {
		append($$anchor, root_4$18());
	};
	var consequent_6 = ($$anchor) => {
		append($$anchor, root_5$13());
	};
	var alternate = ($$anchor) => {
		var text$27 = text();
		text$27.nodeValue = (console.error("Unsupported icon weight. Choose from \"thin\", \"light\", \"regular\", \"bold\", \"fill\", or \"duotone\"."), "");
		append($$anchor, text$27);
	};
	if_block(node_2, ($$render) => {
		if (get(weight) === "bold") $$render(consequent_1);
		else if (get(weight) === "duotone") $$render(consequent_2, 1);
...
function StorageText($$anchor, $$props) {
	...
	component(first_child(fragment), () => Field, ($$anchor, Field_Field) => {
		Field_Field($$anchor, {
			...
			class: "border-border bg-background/60 rounded-md border p-2",
			children: ($$anchor, $$slotProps) => {
							...
							component(node_2, () => Field_label, ($$anchor, Field_Label) => {
								Field_Label($$anchor, {
									...
									children: ($$anchor, $$slotProps) => {
										next$1();
										var text$26 = text();
										template_effect(() => set_text(text$26, $$props.label));
...
var root$59 = from_html(`<a target="_blank" rel="noreferrer" class="text-primary flex items-center gap-1 text-xs hover:underline"> <!></a>`);
var root_1$42 = from_html(`<div class="flex flex-wrap gap-x-2 gap-y-1 px-1"></div>`);
var root_2$37 = from_html(`<!> <!>`, 1);
var root_3$27 = from_html(`<div class="grid gap-1"><!> <div class="border-border bg-background/60 rounded-md border"><!></div> <!></div>`);
...
var root$58 = from_html(`<div class="space-y-2"><!> <!> <!> <!> <!> <!> <!> <!> <!></div>`);
function ConnectionsGroup($$anchor, $$props) {
	...
	if_block(sibling(node_7, 2), ($$render) => {});
	reset(div);
	append($$anchor, div);
	pop();
}
...
var root$57 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Not Found - Section</h2> <p class="text-muted-foreground mt-1 text-sm">Couldn't find your requested preferences section in this group.</p></section>`);
function SectionNotFound($$anchor) {
	append($$anchor, root$57());
}
//#endregion
//#region src/extension/entrypoints/options/components/preferences/PreferenceSettingGroup.svelte
var root$56 = from_html(`<h3> </h3>`);
var root_1$41 = from_html(`<p class="text-muted-foreground text-xs"> </p>`);
var root_2$36 = from_html(`<div class="border-border bg-background/60 rounded-md border p-2"><div class="mb-1"><!> <!></div> <div><!></div></div>`);
...
function Select_portal($$anchor, $$props) {
	let restProps = rest_props($$props, rest_excludes$15);
	var fragment = comment();
...
function Select_scroll_down_button($$anchor, $$props) {
	...
	var node = first_child(fragment);
	{
		let $0 = user_derived(() => cn("bg-popover bottom-0 z-10 flex w-full cursor-default items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4", $$props.class));
...
function Select_scroll_up_button($$anchor, $$props) {
	...
	var node = first_child(fragment);
	{
		let $0 = user_derived(() => cn("bg-popover top-0 z-10 flex w-full cursor-default items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4", $$props.class));
...
var root$54 = from_html(`<span class="absolute end-2 flex size-3.5 items-center justify-center"><!></span> <!>`, 1);
function Select_item($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), restProps = rest_props($$props, rest_excludes$11);
	var fragment = comment();
	var node = first_child(fragment);
	{
		const children = ($$anchor, $$arg0) => {
			...
			var alternate = ($$anchor) => {
				var text$24 = text();
				template_effect(() => set_text(text$24, $$props.label || $$props.value));
		...
		let $0 = user_derived(() => cn("focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground focus:bg-accent data-highlighted:bg-accent data-highlighted:text-accent-foreground focus:text-accent-foreground relative flex w-full cursor-default items-center gap-1.5 rounded-md py-1 pr-8 pl-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2", $$props.class));
...
var root$53 = from_html(`<!> <!>`, 1);
function Select_trigger($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), size = prop($$props, "size", 3, "default"), restProps = rest_props($$props, rest_excludes$10);
	var fragment = comment();
	var node = first_child(fragment);
	{
		let $0 = user_derived(() => cn("border-input data-placeholder:text-muted-foreground dark:bg-input/30 dark:hover:bg-input/50 focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 flex w-fit items-center justify-between gap-1.5 rounded-lg border bg-transparent py-2 pr-2 pl-2.5 text-sm whitespace-nowrap transition-colors outline-none select-none focus-visible:ring-3 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:ring-3 data-[size=default]:h-8 data-[size=sm]:h-7 data-[size=sm]:rounded-[min(var(--radius-md),10px)] *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", $$props.class));
		component(node, () => Select_trigger$1, ($$anchor, SelectPrimitive_Trigger) => {
			SelectPrimitive_Trigger($$anchor, spread_props({
				...
				children: ($$anchor, $$slotProps) => {
					...
					CaretDown(sibling(node_1, 2), { class: "text-muted-foreground pointer-events-none size-4" });
					append($$anchor, fragment_1);
				},
				$$slots: { default: true }
			}));
...
function Select($$anchor, $$props) {
	push($$props, true);
	let open = prop($$props, "open", 15, false), value = prop($$props, "value", 15), restProps = rest_props($$props, rest_excludes$9);
	var fragment = comment();
				...
				component(node_1, () => Select_trigger, ($$anchor, Select_Trigger) => {
					Select_Trigger($$anchor, {
						...
						children: ($$anchor, $$slotProps) => {
							next$1();
							var text$23 = text();
							template_effect(() => set_text(text$23, get(triggerContent)));
							...
							component(node_2, () => Field_label, ($$anchor, Field_Label) => {
								Field_Label($$anchor, {
									...
									children: ($$anchor, $$slotProps) => {
										next$1();
										var text$22 = text();
										template_effect(() => set_text(text$22, $$props.label));
										append($$anchor, text$22);
									},
									$$slots: { default: true }
								});
							});
...
var SERVICE_DETAILS = {
	...
	playgroundTorntools: { name: "Playground TornTools" }
};
//#endregion
//#region src/extension/entrypoints/options/components/preferences/ExternalServiceRequirement.svelte
var root$50 = from_html(`<img class="w-6"/>`);
var root_1$40 = from_html(`<span class="text-[10px] uppercase">Requires</span> <span class="flex gap-1"></span>`, 1);
var root_2$35 = from_html(`<!> <!>`, 1);
							...
							each(span, 21, () => get(requiredServices), (service) => service.name, ($$anchor, service) => {
								Badge($$anchor, {
									...
									children: ($$anchor, $$slotProps) => {
										...
										var alternate = ($$anchor) => {
											var text$21 = text();
											template_effect(() => set_text(text$21, get(service).name));
...
var root$49 = from_html(` <!>`, 1);
var root_1$39 = from_html(`<div class="flex flex-wrap items-center gap-2"><!> <!></div> <!>`, 1);
var root_2$34 = from_html(`<!> <!>`, 1);
var root_3$26 = from_html(`<div class="bg-muted/50 grid gap-1 p-2"><!></div>`);
var root_4$17 = from_html(`<div><!> <!></div>`);
						...
						children: ($$anchor, $$slotProps) => {
							...
							component(node_2, () => Field_label, ($$anchor, Field_Label) => {
								Field_Label($$anchor, {
									...
									children: ($$anchor, $$slotProps) => {
										next$1();
										var fragment_2 = root$49();
										var text = first_child(fragment_2, true);
										snippet(sibling(text), () => $$props.titleAction ?? noop);
...
var root$48 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_1$38 = from_html(`<!> <!>`, 1);
var root_2$33 = from_html(`<!> <!> <!> <!>`, 1);
var root_3$25 = from_html(`<div class="space-y-2"><!> <!> <!></div>`);
function ItemsSection($$anchor) {
			...
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					...
					StorageSwitch(sibling(node_7, 2), {
						path: "settings.pages.items.missingBooks",
						label: "Display missing books"
					});
					append($$anchor, fragment_1);
				},
				$$slots: { default: true }
	...
	PreferenceSectionCard(node_9, {
		title: "Museum Sets",
		children: ($$anchor, $$slotProps) => {
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					var fragment_3 = root_1$38();
	...
	PreferenceSectionCard(sibling(node_9, 2), {
		title: "Item Effects",
		children: ($$anchor, $$slotProps) => {
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					var fragment_5 = root_2$33();
...
var root$47 = from_html(`<!> <!> <!> <!>`, 1);
var root_1$37 = from_html(`<!> <!> <!>`, 1);
var root_2$32 = from_html(`<!> <!>`, 1);
var root_3$24 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
	...
	PreferenceSectionCard(sibling(node_9, 2), {
		...
		children: ($$anchor, $$slotProps) => {
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					StorageSwitch($$anchor, {
						path: "settings.pages.auction.movePagination",
						label: "Move pagination to the top of the list"
					});
				},
				$$slots: { default: true }
			});
...
var root$46 = from_html(`<!> <!> <!> <!>`, 1);
var root_1$36 = from_html(`<!> <!>`, 1);
var root_2$31 = from_html(`<!> <!> <!>`, 1);
var root_3$23 = from_html(`<div class="border-border bg-background/60 rounded-md border"><!></div>`);
var root_4$16 = from_html(`<p class="text-sm text-amber-600 dark:text-amber-400">Requires API data to be loaded.</p>`);
var root_5$12 = from_html(`<div class="grid gap-2"><!> <!></div>`);
var root_6$10 = from_html(`<a href="https://www.beatingbonuses.com/bjstrategy.php?decks=8&amp;soft17=stand&amp;doubleon=any2cards&amp;peek=off&amp;das=on&amp;dsa=on&amp;charlie=on&amp;surrender=earlyf&amp;opt=1&amp;btn=Generate+Strategy" target="_blank" rel="noreferrer" class="text-primary flex items-center gap-1 text-xs hover:underline">Strategy calculator <!></a>`);
var root_7$2 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
function MoneySection($$anchor, $$props) {
	...
	const stockChoices = user_derived(() => ($stockdataStore()?.stocks ?? []).map((stock) => ({
	...
	PreferenceSectionCard(node, {
		children: ($$anchor, $$slotProps) => {
			var fragment = root_1$36();
			var node_1 = first_child(fragment);
			PreferenceSettingGroup(node_1, {
				children: ($$anchor, $$slotProps) => {
					var fragment_1 = root$46();
													...
													component(first_child(fragment_9), () => Field_label, ($$anchor, Field_Label) => {
														Field_Label($$anchor, {
															...
															children: ($$anchor, $$slotProps) => {
																next$1();
																var text$19 = text();
																template_effect(($0) => set_text(text$19, $0), [() => capitalizeText(get(stock).name)]);
...
var root$45 = from_html(`<!> <!> <!>`, 1);
var root_1$35 = from_html(`<!> <!>`, 1);
var root_2$30 = from_html(`<div class="grid gap-1"><!></div>`);
from_html(`<!> <span class="text-muted-foreground m-1 inline-block text-xs">Sometimes it might be necessary for us to collect information about very specific issues. These might share sensitive in-game information (like
			money on hand) with the developers. You should only enable these whenever asked by a developer to help them gather the information we need.</span> <div class="grid gap-1"></div>`, 1);
function AdvancedSection($$anchor) {
	var fragment = root_1$35();
	var node = first_child(fragment);
	PreferenceSectionCard(node, {
	...
	if_block(sibling(node, 2), ($$render) => {});
	append($$anchor, fragment);
}
//#endregion
...
function StorageNumber($$anchor, $$props) {
	...
	const $apiStore = () => store_get(apiStore, "$apiStore", $$stores);
	const [$$stores, $$cleanup] = setup_stores();
	let id = prop($$props, "id", 19, () => $$props.path.replaceAll(".", "-")), min = prop($$props, "min", 3, void 0), max = prop($$props, "max", 3, void 0), step = prop($$props, "step", 3, void 0), disabled = prop($$props, "disabled", 3, false), orientation = prop($$props, "orientation", 3, "responsive");
	const storageSource = user_derived(() => ({
		settings: $settingsStore(),
		api: $apiStore()
	}));
	...
	component(first_child(fragment), () => Field, ($$anchor, Field_Field) => {
		Field_Field($$anchor, {
			...
			class: "border-border bg-background/60 rounded-md border p-2",
			children: ($$anchor, $$slotProps) => {
				var fragment_1 = root$44();
				var node_1 = first_child(fragment_1);
				component(node_1, () => Field_content, ($$anchor, Field_Content) => {
					Field_Content($$anchor, {
						children: ($$anchor, $$slotProps) => {
							var fragment_2 = root$44();
							var node_2 = first_child(fragment_2);
							component(node_2, () => Field_label, ($$anchor, Field_Label) => {
								Field_Label($$anchor, {
									get for() {
									...
									children: ($$anchor, $$slotProps) => {
										next$1();
										var text$18 = text();
										template_effect(() => set_text(text$18, $$props.label));
...
var root$43 = from_html(`<li> </li>`);
var root_1$34 = from_html(`<div class="border-border bg-background/60 rounded-md border p-2"><div class="grid gap-2 md:grid-cols-[1fr_40px_28px]"><!> <!> <!></div></div>`);
var root_2$29 = from_html(`<div class="space-y-1"></div>`);
var root_3$21 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center">No highlights configured.</p>`);
var root_4$15 = from_html(`<div class="text-muted-foreground p-2 text-xs">Placeholders: <ul class="list-disc pl-4"></ul></div> <!>`, 1);
...
var root$42 = from_html(`<div class="border-border bg-background/60 rounded-md border p-2"><div class="grid gap-2 md:grid-cols-[repeat(2,1fr)_28px]"><!> <!> <!></div></div>`);
var root_1$33 = from_html(`<div class="space-y-1"></div>`);
var root_2$28 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center">No colored chats configured.</p>`);
...
var root$41 = from_html(`<!> <!> <!> <!> <!> <!>`, 1);
var root_1$32 = from_html(`<div class="grid gap-1"><!></div>`);
var root_2$27 = from_html(`<div class="space-y-2"><!> <!> <!></div>`);
...
function calculateRevivePrice({ price }) {
	const parts = [];
	if (typeof price?.money === "number") parts.push(formatNumber(price.money, {
		currency: true,
		shorten: 3
	}));
...
var root$40 = from_html(`<span class="text-muted-foreground mb-1 ml-2 text-xs"> </span>`);
...
var root$39 = from_html(`<div class="border-border bg-background/60 rounded-md border p-2"><div class="grid gap-2 md:grid-cols-[8rem_1fr_1fr_28px]"><!> <!> <!> <!></div></div>`);
var root_1$31 = from_html(`<!> <!>`, 1);
var root_2$26 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center">No aliases configured.</p>`);
var root_3$20 = from_html(`<div class="space-y-1"><!></div>`);
...
var root$38 = from_html(`<!> <!> <!> <!>`, 1);
var root_1$30 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_2$25 = from_html(`<!> <!> <!>`, 1);
var root_3$19 = from_html(`<div class="space-y-2"><!> <!></div>`);
...
//#endregion
//#region src/extension/entrypoints/options/components/preferences/global/Reminders.svelte
var root$37 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_1$29 = from_html(`<div class="grid gap-1"><!> <!></div>`);
function Reminders($$anchor) {
	PreferenceSectionCard($$anchor, {
		title: "Reminders",
		description: "Remind you of repeating tasks to not forget them.",
		children: ($$anchor, $$slotProps) => {
			var div = root_1$29();
			var node = child(div);
			StorageSwitch(node, {
				path: "settings.scripts.reminders.show",
				label: "Display reminders",
				children: ($$anchor, $$slotProps) => {
					StorageSwitch($$anchor, {
						path: "settings.scripts.reminders.finished",
						label: "Include finished tasks"
					});
				},
				$$slots: { default: true }
			});
			PreferenceSettingGroup(sibling(node, 2), {
				description: "What reminders should be included in the list?",
				children: ($$anchor, $$slotProps) => {
					var fragment_2 = root$37();
					var node_2 = first_child(fragment_2);
					StorageSwitch(node_2, {
						path: "settings.scripts.reminders.types.energyRefill",
						label: "Energy Refill"
					});
					var node_3 = sibling(node_2, 2);
					StorageSwitch(node_3, {
						path: "settings.scripts.reminders.types.nerveRefill",
						label: "Nerve Refill"
					});
					var node_4 = sibling(node_3, 2);
					StorageSwitch(node_4, {
						path: "settings.scripts.reminders.types.medicalCooldown",
						label: "Medical Cooldown"
					});
					var node_5 = sibling(node_4, 2);
					StorageSwitch(node_5, {
						path: "settings.scripts.reminders.types.boosterCooldown",
						label: "Booster Cooldown"
					});
					var node_6 = sibling(node_5, 2);
					StorageSwitch(node_6, {
						path: "settings.scripts.reminders.types.drugCooldown",
						label: "Drug Cooldown"
					});
					var node_7 = sibling(node_6, 2);
					StorageSwitch(node_7, {
						path: "settings.scripts.reminders.types.bankInvestment",
						label: "Bank Investment"
					});
					var node_8 = sibling(node_7, 2);
					StorageSwitch(node_8, {
						path: "settings.scripts.reminders.types.virusCoding",
						label: "Virus Coding"
					});
					var node_9 = sibling(node_8, 2);
					StorageSwitch(node_9, {
						path: "settings.scripts.reminders.types.missionReward",
						label: "Mission Reward"
					});
					var node_10 = sibling(node_9, 2);
					StorageSwitch(node_10, {
						path: "settings.scripts.reminders.types.oc",
						label: "OC"
					});
					var node_11 = sibling(node_10, 2);
					StorageSwitch(node_11, {
						path: "settings.scripts.reminders.types.ocItem",
						label: "OC Item"
					});
					var node_12 = sibling(node_11, 2);
					StorageSwitch(node_12, {
						path: "settings.scripts.reminders.types.race",
						label: "Race"
					});
					StorageSwitch(sibling(node_12, 2), {
						path: "settings.scripts.reminders.types.education",
						label: "Education"
					});
					append($$anchor, fragment_2);
				},
...
var root$36 = from_svg(`<path d="M208.49,152.49l-72,72a12,12,0,0,1-17,0l-72-72a12,12,0,0,1,17-17L116,187V40a12,12,0,0,1,24,0V187l51.51-51.52a12,12,0,0,1,17,17Z"></path>`);
var root_1$28 = from_svg(`<path d="M200,144l-72,72L56,144Z" opacity="0.2"></path><path d="M207.39,140.94A8,8,0,0,0,200,136H136V40a8,8,0,0,0-16,0v96H56a8,8,0,0,0-5.66,13.66l72,72a8,8,0,0,0,11.32,0l72-72A8,8,0,0,0,207.39,140.94ZM128,204.69,75.31,152H180.69Z"></path>`, 1);
var root_2$24 = from_svg(`<path d="M205.66,149.66l-72,72a8,8,0,0,1-11.32,0l-72-72A8,8,0,0,1,56,136h64V40a8,8,0,0,1,16,0v96h64a8,8,0,0,1,5.66,13.66Z"></path>`);
var root_3$18 = from_svg(`<path d="M204.24,148.24l-72,72a6,6,0,0,1-8.48,0l-72-72a6,6,0,0,1,8.48-8.48L122,201.51V40a6,6,0,0,1,12,0V201.51l61.76-61.75a6,6,0,0,1,8.48,8.48Z"></path>`);
var root_4$14 = from_svg(`<path d="M205.66,149.66l-72,72a8,8,0,0,1-11.32,0l-72-72a8,8,0,0,1,11.32-11.32L120,196.69V40a8,8,0,0,1,16,0V196.69l58.34-58.35a8,8,0,0,1,11.32,11.32Z"></path>`);
var root_5$11 = from_svg(`<path d="M202.83,146.83l-72,72a4,4,0,0,1-5.66,0l-72-72a4,4,0,0,1,5.66-5.66L124,206.34V40a4,4,0,0,1,8,0V206.34l65.17-65.17a4,4,0,0,1,5.66,5.66Z"></path>`);
var root_6$9 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function ArrowDownIcon($$anchor, $$props) {
	push($$props, true);
	const ctx = getIconContext();
	let props = rest_props($$props, rest_excludes$8);
	let weight = user_derived(() => $$props.weight ?? ctx.weight ?? "regular");
	let color = user_derived(() => $$props.color ?? ctx.color ?? "currentColor");
	let size = user_derived(() => $$props.size ?? ctx.size ?? "1em");
	let mirrored = user_derived(() => $$props.mirrored ?? ctx.mirrored ?? false);
	...
	var alternate = ($$anchor) => {
		var text$17 = text();
		text$17.nodeValue = (console.error("Unsupported icon weight. Choose from \"thin\", \"light\", \"regular\", \"bold\", \"fill\", or \"duotone\"."), "");
...
var root$35 = from_svg(`<path d="M208.49,120.49a12,12,0,0,1-17,0L140,69V216a12,12,0,0,1-24,0V69L64.49,120.49a12,12,0,0,1-17-17l72-72a12,12,0,0,1,17,0l72,72A12,12,0,0,1,208.49,120.49Z"></path>`);
var root_1$27 = from_svg(`<path d="M200,112H56l72-72Z" opacity="0.2"></path><path d="M205.66,106.34l-72-72a8,8,0,0,0-11.32,0l-72,72A8,8,0,0,0,56,120h64v96a8,8,0,0,0,16,0V120h64a8,8,0,0,0,5.66-13.66ZM75.31,104,128,51.31,180.69,104Z"></path>`, 1);
var root_2$23 = from_svg(`<path d="M207.39,115.06A8,8,0,0,1,200,120H136v96a8,8,0,0,1-16,0V120H56a8,8,0,0,1-5.66-13.66l72-72a8,8,0,0,1,11.32,0l72,72A8,8,0,0,1,207.39,115.06Z"></path>`);
var root_3$17 = from_svg(`<path d="M204.24,116.24a6,6,0,0,1-8.48,0L134,54.49V216a6,6,0,0,1-12,0V54.49L60.24,116.24a6,6,0,0,1-8.48-8.48l72-72a6,6,0,0,1,8.48,0l72,72A6,6,0,0,1,204.24,116.24Z"></path>`);
var root_4$13 = from_svg(`<path d="M205.66,117.66a8,8,0,0,1-11.32,0L136,59.31V216a8,8,0,0,1-16,0V59.31L61.66,117.66a8,8,0,0,1-11.32-11.32l72-72a8,8,0,0,1,11.32,0l72,72A8,8,0,0,1,205.66,117.66Z"></path>`);
var root_5$10 = from_svg(`<path d="M202.83,114.83a4,4,0,0,1-5.66,0L132,49.66V216a4,4,0,0,1-8,0V49.66L58.83,114.83a4,4,0,0,1-5.66-5.66l72-72a4,4,0,0,1,5.66,0l72,72A4,4,0,0,1,202.83,114.83Z"></path>`);
var root_6$8 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function ArrowUpIcon($$anchor, $$props) {
	push($$props, true);
	const ctx = getIconContext();
	let props = rest_props($$props, rest_excludes$7);
	let weight = user_derived(() => $$props.weight ?? ctx.weight ?? "regular");
	let color = user_derived(() => $$props.color ?? ctx.color ?? "currentColor");
	let size = user_derived(() => $$props.size ?? ctx.size ?? "1em");
	let mirrored = user_derived(() => $$props.mirrored ?? ctx.mirrored ?? false);
	...
	var node_2 = sibling(node, 2);
	var consequent_1 = ($$anchor) => {
		append($$anchor, root$35());
	};
	var consequent_2 = ($$anchor) => {
		var fragment_1 = root_1$27();
		next$1();
		append($$anchor, fragment_1);
	};
	var consequent_3 = ($$anchor) => {
	...
	var alternate = ($$anchor) => {
		var text$16 = text();
		text$16.nodeValue = (console.error("Unsupported icon weight. Choose from \"thin\", \"light\", \"regular\", \"bold\", \"fill\", or \"duotone\"."), "");
...
var root$34 = from_html(`<div class="border-border bg-background/60 rounded-md border p-2"><div class="grid gap-2 lg:grid-cols-[12rem_15rem_1fr]"><!> <!> <!></div> <!> <div class="mt-2 flex flex-wrap gap-1.5"><!> <!> <!> <div class="flex w-full max-w-sm items-center gap-1.5"><!> <!></div></div></div>`);
var root_1$26 = from_html(`<div class="space-y-1"></div>`);
var root_2$22 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center">No custom links configured.</p>`);
...
var root$33 = from_html(`<span class="icon svelte-zigx8g"></span>`);
...
var root$32 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_1$25 = from_html(`<!> <!>`, 1);
var root_2$21 = from_html(`<!> <!> <!> <!> <!> <!>`, 1);
var root_3$16 = from_html(`<!> <!> <!> <!> <!>`, 1);
var root_4$12 = from_html(`<div class="grid gap-1"><!> <!> <!> <!></div>`);
var root_5$9 = from_html(`<div class="flex flex-wrap gap-1"></div>`);
var root_6$7 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
		...
		const action = ($$anchor) => {
			{
				...
				Badge($$anchor, {
					...
					children: ($$anchor, $$slotProps) => {
						next$1();
						var text$14 = text();
						template_effect(() => set_text(text$14, `${get(hiddenIconCount) ?? ""} hidden`));
...
var root$31 = from_html(`TornTools uses a <span class="text-yellow-400">Limited Access</span> key.`, 1);
var root_1$24 = from_html(`<!> <!>`, 1);
var root_2$20 = from_html(`<!> <div class="flex gap-1"><!> <!></div>`, 1);
var root_3$15 = from_html(`<!> <div class="border-border bg-background/60 mt-1 rounded-md border p-2 text-sm"><h3 class="font-bold">Disclaimer</h3> <div class="text-muted-foreground mt-1 space-y-1"><p>The user is allowed to make 100 requests to Torn's API in a minute.</p> <p>The creators of this extension are not responsible if the user:</p> <ul class="list-disc pl-5"><li>spams requests too much</li> <li>tries to use the wrong API key too many times</li></ul> <p>If for some reason you do get your IP blocked because the extension had a bug or glitched or anything, our apologies. Please let us know of such
				incidents so we can avoid them in the future.</p></div></div>`, 1);
		...
		children: ($$anchor, $$slotProps) => {
			...
			component(first_child(fragment_1), () => Field, ($$anchor, Field_Field) => {
				Field_Field($$anchor, {
					...
					class: "border-border bg-background/60 rounded-md border p-2",
					children: ($$anchor, $$slotProps) => {
						var fragment_2 = root_2$20();
						var node_1 = first_child(fragment_2);
						component(node_1, () => Field_content, ($$anchor, Field_Content) => {
							Field_Content($$anchor, {
								children: ($$anchor, $$slotProps) => {
									var fragment_3 = root_1$24();
									var node_2 = first_child(fragment_3);
									component(node_2, () => Field_label, ($$anchor, Field_Label) => {
										Field_Label($$anchor, {
											for: "api-key",
...
var root$30 = from_html(`<!> <!> <!> <!> <!>`, 1);
var root_1$23 = from_html(`<div class="space-y-2"><!> <!> <!></div>`);
...
function NotificationListInput($$anchor, $$props) {
	...
	component(first_child(fragment), () => Field, ($$anchor, Field_Field) => {
		Field_Field($$anchor, {
			...
			class: "border-border bg-background/60 rounded-md border p-2",
			children: ($$anchor, $$slotProps) => {
				var fragment_1 = root$29();
				var node_1 = first_child(fragment_1);
				component(node_1, () => Field_content, ($$anchor, Field_Content) => {
					Field_Content($$anchor, {
						children: ($$anchor, $$slotProps) => {
							var fragment_2 = root$29();
							var node_2 = first_child(fragment_2);
							component(node_2, () => Field_label, ($$anchor, Field_Label) => {
								Field_Label($$anchor, {
									get for() {
									...
									children: ($$anchor, $$slotProps) => {
										next$1();
										var text$12 = text();
										template_effect(() => set_text(text$12, $$props.label));
...
var root$28 = from_html(`<div class="border-border bg-background/60 grid gap-2 rounded-md border p-2 md:grid-cols-[minmax(0,1fr)_5rem_6rem_auto]"><!> <!> <!> <!></div>`);
var root_1$22 = from_html(`<div class="space-y-1"></div>`);
var root_2$19 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center text-xs">No NPC alerts configured.</p>`);
var root_3$14 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center text-xs">NPC data is not available yet.</p>`);
var root_4$11 = from_html(`<div class="grid gap-1"><!> <!> <!></div>`);
...
var root$27 = from_html(`<span data-slot="slider-track"><!></span> <!>`, 1);
function Slider($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), value = prop($$props, "value", 15), orientation = prop($$props, "orientation", 3, "horizontal"), restProps = rest_props($$props, rest_excludes$6);
	var fragment = comment();
	var node = first_child(fragment);
	{
		const children = ($$anchor, $$arg0) => {
			...
			template_effect(($0) => {
				...
				set_class(span, 1, $0);
			}, [() => clsx(cn("bg-muted bg-muted relative grow overflow-hidden rounded-full data-horizontal:h-1 data-horizontal:w-full data-horizontal:w-full data-vertical:h-full data-vertical:h-full data-vertical:w-1"))]);
			append($$anchor, fragment_1);
		};
		let $0 = user_derived(() => cn("relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col", $$props.class));
...
var root$26 = from_svg(`<path d="M234.49,111.07,90.41,22.94A20,20,0,0,0,60,39.87V216.13a20,20,0,0,0,30.41,16.93l144.08-88.13a19.82,19.82,0,0,0,0-33.86ZM84,208.85V47.15L216.16,128Z"></path>`);
var root_1$21 = from_svg(`<path d="M228.23,134.69,84.15,222.81A8,8,0,0,1,72,216.12V39.88a8,8,0,0,1,12.15-6.69l144.08,88.12A7.82,7.82,0,0,1,228.23,134.69Z" opacity="0.2"></path><path d="M232.4,114.49,88.32,26.35a16,16,0,0,0-16.2-.3A15.86,15.86,0,0,0,64,39.87V216.13A15.94,15.94,0,0,0,80,232a16.07,16.07,0,0,0,8.36-2.35L232.4,141.51a15.81,15.81,0,0,0,0-27ZM80,215.94V40l143.83,88Z"></path>`, 1);
var root_2$18 = from_svg(`<path d="M240,128a15.74,15.74,0,0,1-7.6,13.51L88.32,229.65a16,16,0,0,1-16.2.3A15.86,15.86,0,0,1,64,216.13V39.87a15.86,15.86,0,0,1,8.12-13.82,16,16,0,0,1,16.2.3L232.4,114.49A15.74,15.74,0,0,1,240,128Z"></path>`);
var root_3$13 = from_svg(`<path d="M231.36,116.19,87.28,28.06a14,14,0,0,0-14.18-.27A13.69,13.69,0,0,0,66,39.87V216.13a13.69,13.69,0,0,0,7.1,12.08,14,14,0,0,0,14.18-.27l144.08-88.13a13.82,13.82,0,0,0,0-23.62Zm-6.26,13.38L81,217.7a2,2,0,0,1-2.06,0,1.78,1.78,0,0,1-1-1.61V39.87a1.78,1.78,0,0,1,1-1.61A2.06,2.06,0,0,1,80,38a2,2,0,0,1,1,.31L225.1,126.43a1.82,1.82,0,0,1,0,3.14Z"></path>`);
var root_4$10 = from_svg(`<path d="M232.4,114.49,88.32,26.35a16,16,0,0,0-16.2-.3A15.86,15.86,0,0,0,64,39.87V216.13A15.94,15.94,0,0,0,80,232a16.07,16.07,0,0,0,8.36-2.35L232.4,141.51a15.81,15.81,0,0,0,0-27ZM80,215.94V40l143.83,88Z"></path>`);
var root_5$8 = from_svg(`<path d="M230.32,117.9,86.24,29.79a11.91,11.91,0,0,0-12.17-.23A11.71,11.71,0,0,0,68,39.89V216.11a11.71,11.71,0,0,0,6.07,10.33,11.91,11.91,0,0,0,12.17-.23L230.32,138.1a11.82,11.82,0,0,0,0-20.2Zm-4.18,13.37L82.06,219.39a4,4,0,0,1-4.07.07,3.77,3.77,0,0,1-2-3.35V39.89a3.77,3.77,0,0,1,2-3.35,4,4,0,0,1,4.07.07l144.08,88.12a3.8,3.8,0,0,1,0,6.54Z"></path>`);
var root_6$6 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
...
var root$25 = from_svg(`<path d="M200,36H56A20,20,0,0,0,36,56V200a20,20,0,0,0,20,20H200a20,20,0,0,0,20-20V56A20,20,0,0,0,200,36Zm-4,160H60V60H196Z"></path>`);
var root_1$20 = from_svg(`<path d="M208,56V200a8,8,0,0,1-8,8H56a8,8,0,0,1-8-8V56a8,8,0,0,1,8-8H200A8,8,0,0,1,208,56Z" opacity="0.2"></path><path d="M200,40H56A16,16,0,0,0,40,56V200a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Zm0,160H56V56H200V200Z"></path>`, 1);
var root_2$17 = from_svg(`<path d="M216,56V200a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V56A16,16,0,0,1,56,40H200A16,16,0,0,1,216,56Z"></path>`);
var root_3$12 = from_svg(`<path d="M200,42H56A14,14,0,0,0,42,56V200a14,14,0,0,0,14,14H200a14,14,0,0,0,14-14V56A14,14,0,0,0,200,42Zm2,158a2,2,0,0,1-2,2H56a2,2,0,0,1-2-2V56a2,2,0,0,1,2-2H200a2,2,0,0,1,2,2Z"></path>`);
var root_4$9 = from_svg(`<path d="M200,40H56A16,16,0,0,0,40,56V200a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Zm0,160H56V56H200V200Z"></path>`);
var root_5$7 = from_svg(`<path d="M200,44H56A12,12,0,0,0,44,56V200a12,12,0,0,0,12,12H200a12,12,0,0,0,12-12V56A12,12,0,0,0,200,44Zm4,156a4,4,0,0,1-4,4H56a4,4,0,0,1-4-4V56a4,4,0,0,1,4-4H200a4,4,0,0,1,4,4Z"></path>`);
var root_6$5 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
...
var root$24 = from_html(`<!> <!>`, 1);
var root_1$19 = from_html(`<!> Play`, 1);
var root_2$16 = from_html(`<!> Stop`, 1);
var root_3$11 = from_html(`<!> <div class="grid gap-2"><!> <div class="flex justify-end gap-1.5"><!> <!></div></div>`, 1);
var root_4$8 = from_html(`<div class="grid grid-cols-2"><!> <!></div>`);
var root_5$6 = from_html(`<div class="grid grid-cols-2 gap-1"><!> <!> <!> <!></div>`);
function NotificationSoundCard($$anchor, $$props) {
	...
	function loadVoices() {
		set(voices, [{
			value: "default",
			label: "System Default"
		}, ...isSpeechSynthesisAvailable() ? window.speechSynthesis.getVoices().map((voice) => ({
			...
			var consequent_2 = ($$anchor) => {
				...
				component(first_child(fragment_7), () => Field, ($$anchor, Field_Field_2) => {
					Field_Field_2($$anchor, {
						orientation: "responsive",
						class: "border-border bg-background/60 col-span-2 rounded-md border p-2",
						children: ($$anchor, $$slotProps) => {
							var fragment_8 = root_3$11();
							var node_14 = first_child(fragment_8);
							component(node_14, () => Field_content, ($$anchor, Field_Content_2) => {
								Field_Content_2($$anchor, {
									children: ($$anchor, $$slotProps) => {
										var fragment_9 = root$24();
...
var root$22 = from_html(`<div class="grid gap-1"><!> <!> <!></div>`);
var root_1$18 = from_html(`<!> <!> <!> <!> <!> <!> <!> <div class="md:col-span-2"></div> <!> <!>`, 1);
var root_2$15 = from_html(`<!> <!> <!> <!> <!> <!>`, 1);
var root_3$10 = from_html(`<!> <!> <!> <!>`, 1);
var root_4$7 = from_html(`<!> <!>`, 1);
var root_5$5 = from_html(`<div class="grid gap-1"><!> <!> <!> <!> <!></div>`);
var root_6$4 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
...
var root$21 = from_html(`<!> <!> <!> <!> <!>`, 1);
var root_1$17 = from_html(`<div class="grid gap-1"><!> <!> <!> <!> <!> <!></div>`);
var root_2$14 = from_html(`<!> <!> <!> <!> <!> <!>`, 1);
var root_3$9 = from_html(`<div class="grid gap-1"><!> <!></div>`);
var root_4$6 = from_html(`<div class="space-y-2"><!> <!></div>`);
...
var root$20 = from_svg(`<path d="M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm0,192a84,84,0,1,1,84-84A84.09,84.09,0,0,1,128,212Z"></path>`);
var root_1$16 = from_svg(`<path d="M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z" opacity="0.2"></path><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Z"></path>`, 1);
var root_2$13 = from_svg(`<path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>`);
var root_3$8 = from_svg(`<path d="M128,26A102,102,0,1,0,230,128,102.12,102.12,0,0,0,128,26Zm0,192a90,90,0,1,1,90-90A90.1,90.1,0,0,1,128,218Z"></path>`);
var root_4$5 = from_svg(`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Z"></path>`);
var root_5$4 = from_svg(`<path d="M128,28A100,100,0,1,0,228,128,100.11,100.11,0,0,0,128,28Zm0,192a92,92,0,1,1,92-92A92.1,92.1,0,0,1,128,220Z"></path>`);
...
var root$19 = from_html(`<div data-slot="radio-group-indicator" class="flex size-4 items-center justify-center"><!></div>`);
...
function Radio_group($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), value = prop($$props, "value", 15, ""), restProps = rest_props($$props, rest_excludes$1);
	var fragment = comment();
	var node = first_child(fragment);
	{
		let $0 = user_derived(() => cn("grid w-full gap-2", $$props.class));
...
var root$18 = from_html(`<p class="text-muted-foreground text-xs"> </p>`);
var root_1$15 = from_html(`<span class="block font-medium"> </span> <!>`, 1);
var root_2$12 = from_html(`<div class="border-border flex items-center gap-2 rounded-sm border px-2 py-1.5"><!> <!></div>`);
var root_3$7 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><div class="space-y-3"><h3 class="text-sm font-semibold">Page Theme</h3> <!></div></section>`);
...
var root$17 = from_html(`<!> <!>`, 1);
var root_1$14 = from_html(`<div class="border-border bg-background/60 grid gap-2 rounded-md border p-2 md:grid-cols-[1fr_28px]"><!> <!></div>`);
var root_2$11 = from_html(`<div class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center">No allied factions configured.</div>`);
var root_3$6 = from_html(`<div class="space-y-1"><!> <!></div>`);
...
var root$16 = from_html(`<!> <!> <!> <!> <!>`, 1);
var root_1$13 = from_html(`<!> <!> <!>`, 1);
var root_2$10 = from_html(`<!> <!>`, 1);
var root_3$5 = from_html(`<div class="border-border bg-background/60 rounded-md border"><!></div>`);
var root_4$4 = from_html(`<div class="grid gap-2"><!> <!></div>`);
var root_5$3 = from_html(`<!> <!> <!> <!>`, 1);
var root_6$2 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_7$1 = from_html(`<div class="grid gap-1"><!> <!> <!></div>`);
var root_8$1 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
												...
												component(first_child(fragment_5), () => Field_label, ($$anchor, Field_Label) => {
													Field_Label($$anchor, {
														...
														children: ($$anchor, $$slotProps) => {
															next$1();
															var text$6 = text();
															template_effect(() => set_text(text$6, get(option).label));
...
var root_1$12 = from_html(`<div class="border-border bg-background/60 grid gap-2 rounded-md border p-2 md:grid-cols-[1fr_3rem_28px]"><!> <!> <!></div>`);
var root_2$9 = from_html(`<div class="space-y-1"></div>`);
var root_3$4 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center">No inactivity warnings configured.</p>`);
var root_4$3 = from_html(`<div class="space-y-2"><!> <!></div>`);
...
//#endregion
//#region node_modules/phosphor-svelte/lib/GearSixIcon.svelte
...
//#endregion
//#region src/extension/entrypoints/options/components/preferences/PriorityServiceConfiguration.svelte
var root$13 = from_html(`<!> <!>`, 1);
var root_1$10 = from_html(`<div class="border-border bg-background/60 grid grid-cols-[1fr_auto_auto] items-center gap-1 rounded-md border p-2"><span class="text-sm"> </span> <div class="flex w-18 justify-center"><!></div> <!></div>`);
var root_2$7 = from_html(`<!> <div class="space-y-1"><div class="text-muted-foreground grid grid-cols-[1fr_auto_auto] items-center gap-1 text-sm"><span>Service</span> <span class="w-18 text-center">Enabled</span> <span class="w-18 text-center">Priority</span></div> <!></div>`, 1);
function PriorityServiceConfiguration($$anchor, $$props) {
	push($$props, true);
	const $settingsStore = () => store_get(settingsStore, "$settingsStore", $$stores);
	const $apiStore = () => store_get(apiStore, "$apiStore", $$stores);
	const [$$stores, $$cleanup] = setup_stores();
	let usesBest = prop($$props, "usesBest", 3, false);
	...
	function isEnabled(service) {
		return Boolean(getPreferenceValue(get(storageSource), service.pathEnabled));
	}
	function setEnabled(service, value) {
		updatePreferenceValue(service.pathEnabled, value);
	}
	function priority(service) {
		return String(getPreferenceValue(get(storageSource), service.pathPriority) ?? "");
	}
	function setPriority(service, input) {
		updatePreferenceValue(service.pathPriority, input.trim() === "" ? 0 : Number(input));
	}
	var fragment = comment();
	component(first_child(fragment), () => Dialog, ($$anchor, Dialog_Root) => {
		Dialog_Root($$anchor, {
			get open() {
				return get(open);
			},
			...
			children: ($$anchor, $$slotProps) => {
				...
				var node_1 = first_child(fragment_1);
				component(node_1, () => Dialog_trigger, ($$anchor, Dialog_Trigger) => {
					Dialog_Trigger($$anchor, {
						children: ($$anchor, $$slotProps) => {
							Button($$anchor, {
								...
								size: "icon-sm",
								get "aria-label"() {
									return `Configure ${$$props.title ?? ""} services`;
								},
								children: ($$anchor, $$slotProps) => {
									GearSixIcon($$anchor, {});
								},
				...
				component(sibling(node_1, 2), () => Dialog_content, ($$anchor, Dialog_Content) => {
					Dialog_Content($$anchor, {
						class: "sm:max-w-sm md:max-w-md",
						children: ($$anchor, $$slotProps) => {
							var fragment_4 = root_2$7();
							var node_3 = first_child(fragment_4);
							component(node_3, () => Dialog_header, ($$anchor, Dialog_Header) => {
								Dialog_Header($$anchor, {
									children: ($$anchor, $$slotProps) => {
										var fragment_5 = root$13();
										var node_4 = first_child(fragment_5);
										component(node_4, () => Dialog_title, ($$anchor, Dialog_Title) => {
											Dialog_Title($$anchor, {
												children: ($$anchor, $$slotProps) => {
													next$1();
													var text$4 = text();
													template_effect(() => set_text(text$4, `${$$props.title ?? ""} Service Preferences`));
													append($$anchor, text$4);
												},
												$$slots: { default: true }
											});
										});
										component(sibling(node_4, 2), () => Dialog_description, ($$anchor, Dialog_Description) => {
											Dialog_Description($$anchor, {
												children: ($$anchor, $$slotProps) => {
													next$1();
													var text_1 = text();
													template_effect(($0) => set_text(text_1, `Configure your service preferences for ${$0 ?? ""} here. Lowest priority goes first. Services with the same priority will run at the same
				time and will compete for the ${usesBest() ? "best" : "fastest"} response.`), [() => $$props.title.toLowerCase()]);
													append($$anchor, text_1);
												},
												$$slots: { default: true }
											});
							...
							each(sibling(child(div), 2), 17, () => $$props.services, (service) => service.name, ($$anchor, service) => {
								var div_1 = root_1$10();
								var span = child(div_1);
								...
								{
									let $0 = user_derived(() => isEnabled(get(service)));
									Switch(node_7, {
										size: "sm",
										get checked() {
											return get($0);
										},
										onCheckedChange: (checked) => setEnabled(get(service), checked)
									});
								}
								reset(div_2);
								var node_8 = sibling(div_2, 2);
								{
									let $0 = user_derived(() => priority(get(service)));
									Input(node_8, {
										type: "number",
										min: 1,
										class: "with-number-wheel h-7 w-18 text-center text-sm",
										get value() {
											return get($0);
										},
										oninput: (event) => setPriority(get(service), event.currentTarget.value)
									});
								}
								reset(div_1);
								template_effect(() => set_text(text_2, get(service).name));
								append($$anchor, div_1);
							});
							reset(div);
							append($$anchor, fragment_4);
...
var root_4$1 = from_html(`<div class="grid gap-2"><!> <!> <!></div>`);
var root_5$1 = from_html(`<div class="border-border bg-background/60 grid gap-2 rounded-md border p-2 md:grid-cols-[1fr_3rem_28px]"><!> <!> <!></div>`);
var root_6 = from_html(`<div class="space-y-1"></div>`);
var root_7 = from_html(`<p class="border-border text-muted-foreground rounded-md border border-dashed p-2 text-center">No inactivity warnings configured.</p>`);
...
function FactionSection($$anchor, $$props) {
		...
		children: ($$anchor, $$slotProps) => {
			...
			PreferenceSettingGroup(node_1, {
				children: ($$anchor, $$slotProps) => {
					...
					var node_12 = sibling(node_11, 2);
					{
						const titleAction = ($$anchor) => {
							PriorityServiceConfiguration($$anchor, {
								title: "Faction Spies",
								services: [{
									name: "TornStats",
					...
					StorageSwitch(sibling(node_13, 2), {
						path: "settings.pages.faction.warReportHighlight",
						label: "Highlight yourself in war reports"
					});
					append($$anchor, fragment_1);
				},
				$$slots: { default: true }
	...
	PreferenceSectionCard(node_20, {
		...
		children: ($$anchor, $$slotProps) => {
			...
			var node_22 = sibling(node_21, 2);
			PreferenceSettingGroup(node_22, {
				title: "OCs v1",
				children: ($$anchor, $$slotProps) => {
			...
			PreferenceSettingGroup(sibling(node_22, 2), {
				title: "OCs v2",
				children: ($$anchor, $$slotProps) => {
					var fragment_5 = root_2$6();
					...
					StorageSwitch(sibling(node_30, 2), {
...
var root_3$1 = from_html(`<a href="https://www.torn.com/forums.php#/p=threads&amp;f=61&amp;t=16192039" target="_blank" rel="noreferrer" class="text-primary flex items-center gap-1 text-xs hover:underline">Score formula <!></a>`);
		...
		children: ($$anchor, $$slotProps) => {
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					...
					StorageSwitch(sibling(node_47, 2), {
...
var root_2$4 = from_html(`<div class="space-y-2"><!></div>`);
...
var root_2$3 = from_html(`<div class="space-y-2"><!> <!></div>`);
			...
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					...
					StorageSwitch(node_8, {
						...
						label: "Buying items abroad",
						disabled: true,
						description: "Disabled until further notice."
					});
					StorageSwitch(sibling(node_8, 2), {
						path: "settings.scripts.noConfirm.propertiesSell",
						label: "Selling your properties"
					});
					append($$anchor, fragment_2);
				},
				$$slots: { default: true }
		...
		children: ($$anchor, $$slotProps) => {
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					...
					StorageSwitch(sibling(node_8, 2), {
						path: "settings.pages.travel.hideInventoryButton",
						label: "Show button to hide the travel inventory"
					});
					append($$anchor, fragment_5);
				},
				$$slots: { default: true }
		...
		children: ($$anchor, $$slotProps) => {
			PreferenceSettingGroup($$anchor, {
				children: ($$anchor, $$slotProps) => {
					...
					StorageSwitch(sibling(node_13, 2), {
						path: "settings.pages.travel.fastHunting",
						label: "Faster hunting"
					});
					append($$anchor, fragment_7);
				},
				$$slots: { default: true }
...
var root$6 = from_html(`<section class="border-border bg-card rounded-lg border px-3 py-2"><h2 class="text-lg font-bold">Not Found - Group</h2> <p class="text-muted-foreground mt-1 text-sm">Couldn't find your requested preferences group.</p></section>`);
var root_1$4 = from_html(`<div class="flex justify-center"><!></div>`);
...
//#endregion
//#region src/extension/entrypoints/options/components/preferences/preference-search-data.ts
function getLastKey(path) {
	const parts = path.split(".");
	return parts[parts.length - 1];
}
var PREFERENCE_SEARCH_DATA = [
	{
		path: "settings.themes.pages",
		label: "Page Theme",
		group: "internal",
		section: "internal",
		keywords: [
	...
	{
		path: "settings.pages.popup.marketSearch",
		label: "Popup: Market search",
		group: "internal",
		section: "popup",
		keywords: ["bazaar", "item market"]
	},
	{
		path: "settings.pages.popup.calculator",
	...
	{
		path: "settings.pages.icon.global",
		label: "Enable icon bars",
		group: "internal",
		section: "popup"
	},
	{
		path: "settings.pages.icon.energy",
		label: "Icon bars: Energy",
		group: "internal",
		section: "popup"
	},
	{
		path: "settings.pages.icon.nerve",
		label: "Icon bars: Nerve",
		group: "internal",
		section: "popup"
	},
	{
		path: "settings.pages.icon.happy",
		label: "Icon bars: Happy",
		group: "internal",
		section: "popup"
	},
	{
		path: "settings.pages.icon.life",
		label: "Icon bars: Life",
		group: "internal",
		section: "popup"
	},
	{
		path: "settings.pages.icon.chain",
		label: "Icon bars: Chain",
		group: "internal",
		section: "popup"
	},
	{
		path: "settings.pages.icon.travel",
		label: "Icon bars: Travel",
		group: "internal",
		section: "popup"
	},
	{
	...
	{
		path: "settings.notifications.requireInteraction",
		label: "Require interaction for notifications",
		group: "internal",
		section: "notifications"
	},
	{
	...
	{
		path: "settings.notifications.volume",
		label: "Sound volume",
		group: "internal",
		section: "notifications"
	},
	...
	},
	{
		...
		group: "internal",
		section: "notifications",
		keywords: ["text", "text-to-speech"]
	},
	{
		path: "settings.notifications.ttsVoice",
		label: "TTS Voice",
		group: "internal",
		section: "notifications",
		keywords: ["text", "text-to-speech"]
	...
	{
		path: "settings.notifications.types.status",
		label: "Notification: Status change",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.traveling",
		label: "Notification: Traveling",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.education",
		label: "Notification: Education",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.newDay",
		label: "Notification: New day",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.offline",
		label: "Notification: Offline hours",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.leavingHospitalEnabled",
		label: "Notification: Leaving hospital",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.landingEnabled",
		label: "Notification: Landing",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.energy",
		label: "Notification: Energy",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.nerve",
		label: "Notification: Nerve",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.happy",
		label: "Notification: Happy",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.life",
		label: "Notification: Life",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.refillEnergy",
		label: "Notification: Energy refill",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.refillNerveEnabled",
		label: "Notification: Nerve refill",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.cooldowns",
		label: "Notification: Cooldowns",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.cooldownDrugEnabled",
		label: "Notification: Drug cooldown",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.cooldownBoosterEnabled",
		label: "Notification: Booster cooldown",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.cooldownMedicalEnabled",
		label: "Notification: Medical cooldown",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.missionsExpireEnabled",
		label: "Notification: Missions expiry",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.missionsLimitEnabled",
		label: "Notification: Missions limit",
		group: "internal",
		section: "notifications"
	},
	{
	...
	{
		path: "settings.notifications.types.npcs",
		label: "Notification: NPCs",
		group: "internal",
		section: "notifications"
	},
	{
		path: "settings.notifications.types.npcPlannedEnabled",
		label: "Notification: Planned NPC attack",
		group: "internal",
		section: "notifications"
	},
	{
	...
	{
		path: "settings.apiUsage.delayEssential",
		label: "API Usage: essential userdata interval",
		group: "internal",
		section: "api"
	},
	{
		path: "settings.apiUsage.delayBasic",
		label: "API Usage: basic userdata interval",
		group: "internal",
		section: "api"
	},
	{
		path: "settings.apiUsage.delayPassive",
		label: "API Usage: passive userdata interval",
		group: "internal",
		section: "api"
	},
	{
		path: "settings.apiUsage.delayStakeouts",
		label: "API Usage: stakeout interval",
		group: "internal",
		section: "api"
	},
	{
	...
	{
		path: "settings.pages.competitions.easterEggsAlert",
		label: "Highlight Easter Eggs alert",
		group: "global",
		section: "global"
	},
	{
	...
	{
		path: "settings.scripts.achievements.completed",
		label: "Show completed achievements",
		group: "global",
		section: "sidebar"
	},
	{
	...
	{
		path: "settings.pages.sidebar.oc2TimerLevel",
		label: "OC 2.0 include crime level",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.pages.sidebar.oc2TimerPosition",
		label: "OC 2.0 include crime name and position",
		group: "global",
		section: "sidebar"
	},
	{
	...
	{
		path: "settings.scripts.reminders.finished",
		label: "Include reminders with finished tasks",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.energyRefill",
		label: "Reminders: Energy Refill",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.nerveRefill",
		label: "Reminders: Nerve Refill",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.medicalCooldown",
		label: "Reminders: Medical Cooldown",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.boosterCooldown",
		label: "Reminders: Booster Cooldown",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.drugCooldown",
		label: "Reminders: Drug Cooldown",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.bankInvestment",
		label: "Reminders: Bank Investment",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.virusCoding",
		label: "Reminders: Virus Coding",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.missionReward",
		label: "Reminders: Mission Reward",
		group: "global",
		section: "sidebar"
	},
	{
	...
	{
		path: "settings.scripts.reminders.types.ocItem",
		label: "Reminders: OC Item",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.race",
		label: "Reminders: Race",
		group: "global",
		section: "sidebar"
	},
	{
		path: "settings.scripts.reminders.types.education",
		label: "Reminders: Education",
		group: "global",
		section: "sidebar"
	},
	{
	...
	{
		path: "settings.featureDisplayOnlyFailed",
		label: "Feature manager: only failed",
		group: "global",
		section: "advanced"
	},
	{
		path: "settings.featureDisplayHideDisabled",
		label: "Feature manager: hide disabled",
		group: "global",
		section: "advanced"
	},
	{
		path: "settings.featureDisplayHideEmpty",
		label: "Feature manager: hide when empty",
		group: "global",
		section: "advanced"
	},
	{
	...
	{
		path: "settings.pages.casino.highlowMovement",
		label: "Move high-low buttons to make it easier to click through",
		group: "financial",
		section: "money"
	},
	{
	...
	{
		path: "settings.pages.bazaar.fillMax",
		label: "Bazaar Fill Max",
		group: "financial",
		section: "markets"
	},
	{
		path: "settings.pages.bazaar.maxBuyIgnoreCash",
		label: "Bazaar Fill Max ignore cash on hand",
		group: "financial",
		section: "markets"
	},
	{
	...
	{
		path: "settings.pages.shops.maxBuyIgnoreCash",
		label: "Shop Fill Max ignore cash on hand",
		group: "financial",
		section: "markets"
	},
	{
		path: "settings.pages.shops.profit",
		label: "Shop item profits",
		group: "financial",
		section: "markets",
		keywords: ["shops"]
	},
	{
		path: "settings.pages.shops.values",
		label: "Shop item market values",
		group: "financial",
		section: "markets",
		keywords: ["shops"]
	},
	{
		path: "settings.pages.itemmarket.highlightCheapItems",
		label: "Highlight item market items below value",
		group: "financial",
		section: "markets"
	},
	{
	...
	{
		path: "settings.pages.items.canGains",
		label: "Energy drink gains",
		group: "financial",
		section: "items"
	},
	{
		path: "settings.pages.items.candyHappyGains",
		label: "Candy happy gains",
		group: "financial",
		section: "items"
	},
	{
		path: "settings.pages.items.nerveGains",
		label: "Alcohol nerve gains",
		group: "financial",
		section: "items"
	},
	{
	...
	{
		path: "settings.pages.city.combineDuplicates",
		label: "Combine duplicate city map items",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.scripts.lastAction.factionMember",
		label: "Last action: Faction members",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.scripts.lastAction.companyOwn",
		label: "Last action: Own company employees",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.scripts.lastAction.companyOther",
		label: "Last action: Other company employees",
		group: "qol",
		section: "information"
	},
	{
	...
	{
		path: "settings.pages.forums.debugInfoBtn",
		label: "Display button to add debugging information to forum thread",
		group: "qol",
		section: "information"
	},
	{
	...
	{
		path: "settings.pages.missions.rewards",
		label: "Mission reward information",
		group: "qol",
		section: "information",
		keywords: ["missions"]
	},
	...
	{
		path: "settings.pages.api.autoDemo",
		label: "Automatically show demo content on API page",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.api.autoFillKey",
		label: "Automatically fill your API key on API page",
		group: "qol",
		section: "information"
	},
	{
	...
	{
		path: "settings.pages.auction.filter",
		label: "Filter: Auction House",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.bounties.filter",
		label: "Filter: Bounties",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.faction.armoryFilter",
		label: "Filter: Faction Armory",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.faction.memberFilter",
		label: "Filter: Faction Members",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.faction.rankedWarFilter",
		label: "Filter: Ranked War",
		group: "qol",
		section: "information",
		keywords: ["faction"]
	},
	...
	{
		path: "settings.pages.shops.filters",
		label: "Filter: City Shops",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.travel.itemFilter",
		label: "Filter: Travel Items",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.travel.peopleFilter",
		label: "Filter: Abroad People",
		group: "qol",
		section: "information"
	},
	{
		path: "settings.pages.userlist.filter",
		label: "Filter: Userlist",
		group: "qol",
		section: "information"
	},
	{
	...
	{
		path: "settings.pages.attack.timeoutWarning",
		label: "Play a sound when attack time drops below 30 seconds",
		group: "qol",
		section: "combat"
	},
	{
	...
	{
		path: "settings.pages.attack.bonusInformation",
		label: "Show weapon bonus information in attack log",
		group: "qol",
		section: "combat"
	},
	{
	...
	{
		path: "settings.scripts.statsEstimate.maxLevel",
		label: "Stats Estimate: max level",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.delay",
		label: "Stats Estimate: delay requests",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.cachedOnly",
		label: "Stats Estimate: only show cached results",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.displayNoResult",
		label: "Stats Estimate: show notice when no cached result",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.profiles",
		label: "Stats Estimate: Profiles",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.enemies",
		label: "Stats Estimate: Enemies list",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.targets",
		label: "Stats Estimate: Targets list",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.hof",
		label: "Stats Estimate: Hall of Fame",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.attacks",
		label: "Stats Estimate: Attacks page",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.userlist",
		label: "Stats Estimate: Userlist",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.bounties",
		label: "Stats Estimate: Bounties",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.factions",
		label: "Stats Estimate: Faction members",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.wars",
		label: "Stats Estimate: Faction wars",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.rankedWars",
		label: "Stats Estimate: Faction ranked wars",
		group: "qol",
		section: "combat"
	},
	{
		path: "settings.scripts.statsEstimate.abroad",
		label: "Stats Estimate: Abroad",
		group: "qol",
		section: "combat"
	},
	{
	...
	{
		path: "settings.pages.travel.travelProfits",
		label: "Show profits of items in market while abroad",
		group: "qol",
		section: "travel"
	},
	{
		path: "settings.pages.travel.fillMax",
		label: "Show fill max button while abroad",
		group: "qol",
		section: "travel"
	},
	{
		path: "settings.pages.travel.autoFillMax",
		label: "Automatically fill max amount of stock while abroad",
		group: "qol",
		section: "travel"
	},
	{
	...
	{
		path: "settings.pages.travel.efficientRehabSelect",
		label: "Automatically set rehab slider to the current amount",
		group: "qol",
		section: "travel"
	},
	{
	...
	{
		path: "settings.pages.faction.showFullInfobox",
		label: "Show full faction description without scroll bar",
		group: "qol",
		section: "faction"
	},
	{
		path: "settings.pages.faction.foldableInfobox",
		label: "Make faction infobox foldable",
		group: "qol",
		section: "faction"
	},
	{
	...
	{
		path: "settings.pages.faction.showFactionSpy",
		label: "Show spy details of faction members",
		group: "qol",
		section: "faction"
	},
	{
	...
	{
		path: "settings.pages.faction.csvRankedWarReport",
		label: "CSV: Ranked war report",
		group: "qol",
		section: "faction"
	},
	{
		path: "settings.pages.faction.csvWarReport",
		label: "CSV: War report",
		group: "qol",
		section: "faction"
	},
	{
		path: "settings.pages.faction.csvChainReport",
		label: "CSV: Chain report",
		group: "qol",
		section: "faction"
	},
	{
		path: "settings.pages.faction.csvChallengeContributions",
		label: "CSV: Challenge contributions",
		group: "qol",
		section: "faction"
	},
	{
	...
	{
		path: "settings.pages.profile.boxFetch",
		label: "Profile box: automatically fetch data from the API",
		group: "qol",
		section: "profile"
	},
	{
		path: "settings.pages.profile.boxStats",
		label: "Profile box: display personal stats",
		group: "qol",
		section: "profile"
	},
	{
		path: "settings.pages.profile.boxSpy",
		label: "Profile box: show known spy results",
		group: "qol",
		section: "profile"
	},
	{
		path: "settings.pages.profile.boxStakeout",
		label: "Profile box: enable stakeout options",
		group: "qol",
		section: "profile"
	},
	{
		path: "settings.pages.profile.boxAttackHistory",
		label: "Profile box: show your attack history",
		group: "qol",
		section: "profile"
	},
	{
	...
	{
		path: "settings.pages.companies.specials",
		label: "Help with company specials",
		group: "qol",
		section: "companies"
	},
	{
	...
	{
		path: "settings.pages.gym.disableStats",
		label: "Allow stats to be disabled in gym",
		group: "qol",
		section: "gym"
	},
	{
	...
	{
		path: "settings.scripts.noConfirm.itemEquip",
		label: "No confirm: Equipping items",
		group: "qol",
		section: "speed"
	},
	{
		path: "settings.scripts.noConfirm.tradeAccept",
		label: "No confirm: Accepting trades",
		group: "qol",
		section: "speed"
	},
	{
		path: "settings.scripts.noConfirm.pointsMarketBuy",
		label: "No confirm: Buying points from the market",
		group: "qol",
		section: "speed"
	},
	{
		path: "settings.scripts.noConfirm.pointsMarketRemove",
		label: "No confirm: Removing points from the market",
		group: "qol",
		section: "speed"
	},
	{
		path: "settings.scripts.noConfirm.abroadItemBuy",
		label: "No confirm: Buying items abroad",
		group: "qol",
		section: "speed"
	},
	{
		path: "settings.scripts.noConfirm.propertiesSell",
		label: "No confirm: Selling your properties",
		group: "qol",
		section: "speed",
		keywords: ["property"]
	},
	{
		path: "settings.external.tornstats",
		label: "Enable TornStats",
		group: "connections",
		section: "services"
	},
	{
		path: "api.tornstats.key",
	...
	{
		path: "settings.external.tornw3b",
		label: "Enable TornW3B",
		group: "connections",
		section: "services"
	},
	{
		path: "settings.external.ffScouter",
		label: "Enable FFScouter",
		group: "connections",
		section: "services",
		keywords: ["ff scouter", "ff-scouter"]
	},
	{
		path: "api.ffScouter.key",
		label: "FFScouter API key",
		group: "connections",
		section: "services"
	},
	{
		path: "settings.external.tornintel",
		label: "Enable Torn Intel",
		group: "connections",
		section: "services"
	}
];
//#endregion
//#region src/extension/entrypoints/options/components/preferences/PreferenceSearch.svelte
var root$5 = from_html(`<!> <!>`, 1);
var root_1$3 = from_html(`<span class="text-muted-foreground truncate text-xs"> </span>`);
var root_2$2 = from_html(`<div><span class="truncate text-sm"> </span> <!></div>`);
function PreferenceSearch($$anchor, $$props) {
	push($$props, true);
	let open = prop($$props, "open", 15, false);
	const groupedData = user_derived(() => PREFERENCE_GROUPS.filter((group) => PREFERENCE_SEARCH_DATA.some((item) => item.group === group.id)).flatMap((group) => {
		const groupItems = PREFERENCE_SEARCH_DATA.filter((item) => item.group === group.id);
		return (group.sections ?? []).filter((section) => groupItems.some((item) => item.section === section.id)).map((section) => ({
	...
	function getKeywords(item) {
		return [
			item.label,
			getLastKey(item.path),
			...item.keywords ?? []
		].filter((t) => !!t);
	}
	function selectPreference(item) {
		open(false);
		push$1(getPreferenceSectionRoute(item.group, item.section));
	}
				...
				component(first_child(fragment_1), () => Dialog_content, ($$anchor, Dialog_Content) => {
					Dialog_Content($$anchor, {
						...
						children: ($$anchor, $$slotProps) => {
									...
									children: ($$anchor, $$slotProps) => {
										...
										component(node_3, () => Dialog_title, ($$anchor, Dialog_Title) => {
											Dialog_Title($$anchor, {
												children: ($$anchor, $$slotProps) => {
													next$1();
													append($$anchor, text("Search preferences"));
												},
												$$slots: { default: true }
											});
										});
										component(sibling(node_3, 2), () => Dialog_description, ($$anchor, Dialog_Description) => {
											Dialog_Description($$anchor, {
												children: ($$anchor, $$slotProps) => {
													next$1();
													append($$anchor, text("Search through the TornTools preferences."));
												},
												$$slots: { default: true }
											});
										});
							...
							component(sibling(node_2, 2), () => Command, ($$anchor, Command_Root) => {
								Command_Root($$anchor, {
									children: ($$anchor, $$slotProps) => {
										var fragment_4 = root$5();
										var node_6 = first_child(fragment_4);
										component(node_6, () => Command_input, ($$anchor, Command_Input) => {
											Command_Input($$anchor, { placeholder: "Search preferences" });
										});
										component(sibling(node_6, 2), () => Command_list, ($$anchor, Command_List) => {
											Command_List($$anchor, {
												children: ($$anchor, $$slotProps) => {
													var fragment_5 = root$5();
													var node_8 = first_child(fragment_5);
													component(node_8, () => Command_empty, ($$anchor, Command_Empty) => {
														Command_Empty($$anchor, {
															children: ($$anchor, $$slotProps) => {
																next$1();
																append($$anchor, text("No preferences found."));
															},
															$$slots: { default: true }
														});
													});
													each(sibling(node_8, 2), 17, () => get(groupedData), (group) => group.key, ($$anchor, group) => {
														var fragment_6 = comment();
														component(first_child(fragment_6), () => Command_group, ($$anchor, Command_Group) => {
															Command_Group($$anchor, {
																get heading() {
																	return get(group).heading;
																},
																children: ($$anchor, $$slotProps) => {
																	var fragment_7 = comment();
																	each(first_child(fragment_7), 17, () => get(group).items, (item) => item.path, ($$anchor, item) => {
																		var fragment_8 = comment();
																		var node_12 = first_child(fragment_8);
																		{
																			let $0 = user_derived(() => getKeywords(get(item)));
																			component(node_12, () => Command_item, ($$anchor, Command_Item) => {
																				Command_Item($$anchor, {
																					get value() {
																					...
																					onSelect: () => selectPreference(get(item)),
																					children: ($$anchor, $$slotProps) => {
																						var div = root_2$2();
																						var span = child(div);
																						...
																						var consequent = ($$anchor) => {
																							...
																							reset(span_1);
																							template_effect(() => set_text(text_4, get(item).description));
																							append($$anchor, span_1);
																						};
...
var root$4 = from_html(`<!> <span class="flex-1">Search</span> <!>`, 1);
var root_1$2 = from_html(`<div><a> </a></div>`);
var root_2$1 = from_html(`<aside class="border-sidebar bg-sidebar flex flex-col space-y-1 rounded-lg border p-2"><!> <div class="space-y-1"></div></aside> <!>`, 1);
function PreferencesNavigation($$anchor, $$props) {
	push($$props, true);
	let searchOpen = state(false);
	const shortcutKey = user_derived(() => navigator.platform.startsWith("Mac") ? "⌘" : "Ctrl");
	...
	Button(node, {
		...
		children: ($$anchor, $$slotProps) => {
			...
			var node_1 = first_child(fragment_1);
			MagnifyingGlassIcon(node_1, {});
			component(sibling(node_1, 4), () => Kbd_group, ($$anchor, Kbd_Group) => {
				Kbd_Group($$anchor, {
					children: ($$anchor, $$slotProps) => {
						var fragment_2 = comment();
						component(first_child(fragment_2), () => Kbd, ($$anchor, Kbd_Root) => {
							Kbd_Root($$anchor, {
								children: ($$anchor, $$slotProps) => {
									next$1();
									var text$2 = text();
									template_effect(() => set_text(text$2, `${get(shortcutKey) ?? ""} + K`));
	...
	each(div, 21, () => PREFERENCE_GROUPS, (group) => group.id, ($$anchor, group) => {
		var div_1 = root_1$2();
		var a = child(div_1);
	...
	reset(div);
	reset(aside);
	PreferenceSearch(sibling(aside, 2), {
		get open() {
...
var root$3 = from_html(`<a><span class="block font-medium"> </span></a>`);
var root_1$1 = from_html(`<section class="border-border bg-card rounded-lg border p-2"><div class="grid gap-2 sm:grid-cols-2 lg:grid-cols-3"></div></section>`);
...
var root$2 = from_html(`<section class="grid gap-2 lg:grid-cols-[11rem_1fr]"><!> <div class="space-y-2"><!> <!></div></section>`);
...
var root_1 = from_html(`<li><span class="text-foreground font-medium"> </span> <span class="block break-all"> </span></li>`);
var root_2 = from_html(`<div class="border-border bg-muted/30 rounded-lg border p-2 text-sm"><h3 class="font-medium">Missing permissions:</h3> <ul class="text-muted-foreground mt-2 list-disc space-y-1 pl-5"></ul></div>`);
...
function MissingPermissions($$anchor, $$props) {
	...
	async function getMissingOrigins(origins) {
		return (await Promise.all(origins.map(async (origin) => ({
			...origin,
...
//# sourceMappingURL=options-CSL2YxJI.js.map