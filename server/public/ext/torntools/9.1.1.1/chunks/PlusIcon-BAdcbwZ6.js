import { $t as snapshot, Ft as sibling, H as rest_props, Nt as child, Pt as first_child, Rt as set, Tt as get, U as spread_props, V as prop, Vt as user_derived, W as init, Xt as pop, Y as attribute_effect, Zt as push, _t as props_id, c as cn, en as next, gt as from_svg, ht as from_html, it as snippet, lt as if_block, mt as comment, nn as noop, pt as append, q as bind_value, rt as component, tn as reset, vt as text } from "./dist-DM3lq6UN.js";
import { B as createId, Ct as srOnlyStyles, St as Context, V as noop$1, W as isHTMLElement, at as boolToEmptyStrOrUndef, ct as boolToTrueOrUndef, dt as getDataChecked, kt as boxWith, lt as createBitsAttrs, m as getIconContext, mt as attachRef, ot as boolToStr, u as Check, ut as getAriaChecked, wt as mergeProps, xt as watch } from "./TrashIcon-DJq8vlLE.js";
...
var root$6 = from_html(`<input/>`);
function Hidden_input($$anchor, $$props) {
	push($$props, true);
	let value = prop($$props, "value", 15), restProps = rest_props($$props, rest_excludes$7);
...
function Switch_thumb($$anchor, $$props) {
	const uid = props_id();
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), restProps = rest_props($$props, rest_excludes$4);
...
var root$2 = from_svg(`<path d="M228,128a12,12,0,0,1-12,12H40a12,12,0,0,1,0-24H216A12,12,0,0,1,228,128Z"></path>`);
var root_1$1 = from_svg(`<path d="M216,56V200a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V56A16,16,0,0,1,56,40H200A16,16,0,0,1,216,56Z" opacity="0.2"></path><path d="M224,128a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,128Z"></path>`, 1);
var root_2$1 = from_svg(`<path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM184,136H72a8,8,0,0,1,0-16H184a8,8,0,0,1,0,16Z"></path>`);
var root_3$1 = from_svg(`<path d="M222,128a6,6,0,0,1-6,6H40a6,6,0,0,1,0-12H216A6,6,0,0,1,222,128Z"></path>`);
var root_4$1 = from_svg(`<path d="M224,128a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,128Z"></path>`);
var root_5$1 = from_svg(`<path d="M220,128a4,4,0,0,1-4,4H40a4,4,0,0,1,0-8H216A4,4,0,0,1,220,128Z"></path>`);
...
var root$1 = from_html(`<div data-slot="checkbox-indicator" class="grid place-content-center text-current transition-none [&amp;>svg]:size-3.5"><!></div>`);
function Checkbox($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), checked = prop($$props, "checked", 15, false), indeterminate = prop($$props, "indeterminate", 15, false), restProps = rest_props($$props, rest_excludes$2);
	var fragment = comment();
	var node = first_child(fragment);
	{
...
function Switch($$anchor, $$props) {
	push($$props, true);
	let ref = prop($$props, "ref", 15, null), checked = prop($$props, "checked", 15, false), size = prop($$props, "size", 3, "default"), restProps = rest_props($$props, rest_excludes$1);
	var fragment = comment();
	var node = first_child(fragment);
	{
...
var root = from_svg(`<path d="M228,128a12,12,0,0,1-12,12H140v76a12,12,0,0,1-24,0V140H40a12,12,0,0,1,0-24h76V40a12,12,0,0,1,24,0v76h76A12,12,0,0,1,228,128Z"></path>`);
var root_1 = from_svg(`<path d="M216,56V200a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V56A16,16,0,0,1,56,40H200A16,16,0,0,1,216,56Z" opacity="0.2"></path><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path>`, 1);
var root_2 = from_svg(`<path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM184,136H136v48a8,8,0,0,1-16,0V136H72a8,8,0,0,1,0-16h48V72a8,8,0,0,1,16,0v48h48a8,8,0,0,1,0,16Z"></path>`);
var root_3 = from_svg(`<path d="M222,128a6,6,0,0,1-6,6H134v82a6,6,0,0,1-12,0V134H40a6,6,0,0,1,0-12h82V40a6,6,0,0,1,12,0v82h82A6,6,0,0,1,222,128Z"></path>`);
var root_4 = from_svg(`<path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path>`);
var root_5 = from_svg(`<path d="M220,128a4,4,0,0,1-4,4H132v84a4,4,0,0,1-8,0V132H40a4,4,0,0,1,0-8h84V40a4,4,0,0,1,8,0v84h84A4,4,0,0,1,220,128Z"></path>`);
...
//# sourceMappingURL=PlusIcon-BAdcbwZ6.js.map