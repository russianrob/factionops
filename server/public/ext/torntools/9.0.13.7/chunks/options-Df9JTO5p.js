import { $ as set_class, At as template_effect, B as onDestroy, Bt as set, Ct as on, Et as get, Ft as child, G as init, Gt as setup_stores, H as prop, Ht as derived_safe_equal, It as first_child, K as bind_this, Kt as store_get, Lt as sibling, Mt as user_pre_effect, Ot as untrack, Pt as $window, Q as set_style, Qt as push, Rt as proxy, St as event, Tt as deep_read_state, U as rest_props, Ut as user_derived, V as onMount, Vt as state, W as spread_props, X as attribute_effect, Z as set_attribute, Zt as pop, _t as from_svg, a as BACKGROUND_SERVICE, at as snippet, b as userdata, bt as delegate, c as cn, ct as index, dt as mount, et as clsx, ft as set_text, gt as from_html, ht as comment, i as exposeDebugObjects, in as to_array, it as component, jt as user_effect, m as loadDatabase, mt as append, n as setMode, nn as reset, nt as action, ot as html, p as initializeDatabase, qt as writable, rn as noop, st as each, t as Mode_watcher, tn as next, ut as if_block, v as storageListeners, vt as props_id, xt as delegated, yt as text, z as ttStorage, zt as mutable_source } from "./dist-_zJwT7ZA.js";
import { A as browser, c as isNumber, g as elementBuilder, l as isSpeechSynthesisAvailable, m as toClipboard, r as TO_MILLIS, t as MONTHS } from "./utilities-B1TyU249.js";
import { At as onMountEffect, Bt as formatBytes, C as getFloatingContentCSSVars, Ct as Previous, Dt as DOMContext, Et as attachRef, F as forward, Ft as boxWith, Gt as hasAPIData, Ht as formatNumber, I as getNextMatch, J as createId, Jt as push$1, Kt as Router, L as isValidIndex, Lt as capitalizeText, M as DOMTypeahead, N as boxAutoReset, Nt as mergeProps, Ot as afterTick, P as backward, Pt as executeCallbacks, Q as isElementOrSVGElement, R as next$1, Rt as daySuffix, S as FloatingAnchorState, St as getDataTransitionAttrs, Tt as Context, Ut as formatTime, V as Portal, Vt as formatDate, X as PresenceManager, Xt as router, Y as noop$1, Yt as replace, Z as RovingFocusGroup, _ as tv, _t as boolToTrueOrUndef, a as Tooltip_trigger, b as Popper_layer, c as Tooltip, d as Badge, dt as PAGE_DOWN, et as isIOS, f as toast, ft as PAGE_UP, gt as boolToStrTrueOrUndef, h as Button, ht as boolToStr, i as active, it as ARROW_UP, jt as onDestroyEffect, kt as afterSleep, l as Sonner_1, lt as HOME, m as getIconContext, mt as boolToEmptyStrOrUndef, n as Input, nt as ARROW_LEFT, o as Tooltip_provider, qt as link, r as registerExtensionContext, rt as ARROW_RIGHT, s as Tooltip_content, t as TrashIcon, tt as ARROW_DOWN, u as Check, v as Separator, vt as createBitsAttrs, wt as watch, x as Floating_layer, xt as getDataOpenClosed, y as Popper_layer_force_mount, yt as getAriaChecked, z as prev } from "./TrashIcon-CpHrnLBj.js";
import { A as ALL_AREAS, C as Dialog_header, D as Dialog, E as Dialog_content, F as HIGHLIGHT_PLACEHOLDERS, L as TORNTOOLS_FORUM_POST, M as CASINO_GAMES, N as CHAT_TITLE_COLORS, O as Textarea, P as CUSTOM_LINKS_PRESET, S as Dialog_title, T as Dialog_description, _ as Card_content, b as fetchData, c as Command_group, d as MagnifyingGlassIcon, f as changeAPIKey, g as Card_description, h as Card_header, i as Command_input, j as ALL_ICONS, k as Spinner, l as Command_empty, m as Card_title, n as Command_list, p as checkAPIPermission, r as Command_item, u as Command, v as Card, w as Dialog_footer, x as Dialog_trigger, y as FETCH_PLATFORMS } from "./command-t-Zfmthh.js";
import { i as Hidden_input, n as Switch, r as Checkbox, t as PlusIcon } from "./PlusIcon-CGIQkYQH.js";
//#region src/extension/svelte/components/ui/kbd/kbd.svelte
var root$67 = from_html(`<kbd><!></kbd>`);
...
var root_2$63 = from_html(`<div><!></div>`);
...
var root_2$62 = from_html(`<div><!></div>`);
...
var root_2$60 = from_html(`<button><!></button>`);
...
var root_2$58 = from_html(`<label><!></label>`);
...
var root_2$56 = from_html(`<button><!></button>`);
...
var root_4$27 = from_html(`<div><div><!></div></div>`);
var root_8$9 = from_html(`<div><div><!></div></div>`);
...
var root_3$37 = from_html(`<button><!></button>`);
...
var root_2$54 = from_html(`<div><!></div>`);
...
var root_2$53 = from_html(`<span><!></span>`);
...
var root_2$52 = from_html(`<span><!></span>`);
...
var root$62 = from_html(`<a class="text-primary underline-offset-1 hover:underline" target="_blank" rel="noreferrer"><!></a>`);
...
var root_5$28 = from_html(`<!> <!>`, 1);
var root$61 = from_html(`<section class="rounded-lg border border-border bg-card py-2 px-3"><h2 class="text-lg font-bold">Contact</h2> <div class="mt-2 space-y-1"><p>Our source code is available on <!> and licensed under the GNU General Public Licence. Our terms of service can be found <!>.</p> <p>We can be contacted through our <!> or <!>.</p> <!> <div><p>Suggestions and bug reports are important to keep improving TornTools. When reporting a bug, include:</p> <ul class="mt-1 pl-4 list-disc text-muted-foreground"><li>Screenshots of the bug in action.</li> <li>Screenshots of the console output. <ul class="pl-4 list-disc"><li>Console access via <!> , or right click -> inspect -> console.</li></ul></li></ul></div></div></section>`);
...
var root_2$50 = from_html(`<a class="text-lg text-primary font-bold underline-offset-2 hover:underline" target="_blank" rel="noreferrer"> </a>`);
var root_3$34 = from_html(`<p class="text-lg text-primary font-bold"> </p>`);
var root_5$27 = from_html(`<a class="underline-offset-1 hover:underline" target="_blank" rel="noreferrer"> </a>`);
var root_4$26 = from_html(`<div class="flex flex-col gap-0.5"></div>`);
var root_1$42 = from_html(`<div class="rounded-lg border border-border p-2"><!> <p class="text-muted-foreground"> </p> <!> <!></div>`);
var root$60 = from_html(`<div class="grid grid-cols-2 lg:grid-cols-4 gap-2 "></div>`);
...
var root$59 = from_html(`<section class="rounded-lg border border-border bg-card py-2 px-3"><h2 class="text-lg font-bold">Team</h2> <p class="text-sm text-muted-foreground">TornTools is free to use but if you feel like giving back to the developers then feel free to donate in-game or via one of the donation links.</p> <div class="my-2"><!></div> <p class="text-sm text-muted-foreground">and everyone else who contributed to our codebase, helped us beta-test, provided feedback, suggestions and bug reports, or just generally helped out in the Discord.</p></section>`);
...
var root$58 = from_html(`<article><p class="rounded-lg border border-border p-2 text-sm"><strong class="text-sm"> </strong> <span> </span></p></article>`);
...
var root_1$41 = from_html(`<div class="mt-2 gap-3 grid md:grid-cols-2"></div>`);
var root_3$33 = from_html(`<p class="mt-2 text-sm text-muted-foreground">Data health checks are not relevant without an API key configured.</p>`);
var root$57 = from_html(`<section class="rounded-lg border border-border bg-card py-2 px-3"><h2 class="text-lg font-bold">Data health</h2> <!></section>`);
...
var root_1$40 = from_html(`<span> </span> <!>`, 1);
...
var root_1$39 = from_html(`<div class="grid gap-2 sm:grid-cols-2"><!> <!> <!> <!></div>`);
var root_2$49 = from_html(`<p class="text-sm text-muted-foreground">Data health checks are not relevant without an API key configured.</p>`);
var root$56 = from_html(`<section class="rounded-lg border border-border bg-card py-2 px-3"><h2 class="text-lg font-bold">Maintenance</h2> <div class="mt-2 grid gap-4 lg:grid-cols-[2fr_1fr]"><section class="space-y-2"><h3 class="text-sm font-bold">Force update</h3> <!></section> <section class="space-y-2"><h3 class="text-sm font-bold">Other</h3> <div class="grid gap-2"><!> <!></div></section></div></section>`);
...
var root_1$38 = from_html(`<span class="font-medium"> </span>`);
var root_2$48 = from_html(`<span> </span>`);
var root$55 = from_html(`<section class="rounded-lg border border-border bg-card py-2 px-3"><h2 class="text-lg font-bold">Version</h2> <div class="mt-2 space-y-2 text-sm"><p>Version: <span class="font-medium"> </span></p> <p class="flex items-center gap-1">Disk space used: <!></p></div></section>`);
...
var root$54 = from_html(`<section class="space-y-4"><!> <!> <!> <!> <!></section>`);
...
var root_1$37 = from_html(`<div><!></div>`);
...
var root_2$47 = from_svg(`<path d="M216.49,104.49l-80,80a12,12,0,0,1-17,0l-80-80a12,12,0,0,1,17-17L128,159l71.51-71.52a12,12,0,0,1,17,17Z"></path>`);
var root_3$32 = from_svg(`<path d="M208,96l-80,80L48,96Z" opacity="0.2"></path><path d="M215.39,92.94A8,8,0,0,0,208,88H48a8,8,0,0,0-5.66,13.66l80,80a8,8,0,0,0,11.32,0l80-80A8,8,0,0,0,215.39,92.94ZM128,164.69,67.31,104H188.69Z"></path>`, 1);
var root_4$25 = from_svg(`<path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,48,88H208a8,8,0,0,1,5.66,13.66Z"></path>`);
var root_5$26 = from_svg(`<path d="M212.24,100.24l-80,80a6,6,0,0,1-8.48,0l-80-80a6,6,0,0,1,8.48-8.48L128,167.51l75.76-75.75a6,6,0,0,1,8.48,8.48Z"></path>`);
var root_6$23 = from_svg(`<path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>`);
var root_7$22 = from_svg(`<path d="M210.83,98.83l-80,80a4,4,0,0,1-5.66,0l-80-80a4,4,0,0,1,5.66-5.66L128,170.34l77.17-77.17a4,4,0,1,1,5.66,5.66Z"></path>`);
var root$53 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function CaretDown($$anchor, $$props) {
	...
	var consequent_4 = ($$anchor) => {
		append($$anchor, root_5$26());
	};
	var consequent_5 = ($$anchor) => {
		append($$anchor, root_6$23());
	};
	var consequent_6 = ($$anchor) => {
		append($$anchor, root_7$22());
	};
	var alternate = ($$anchor) => {
		var text$37 = text();
...
var root_2$46 = from_svg(`<path d="M216.49,168.49a12,12,0,0,1-17,0L128,97,56.49,168.49a12,12,0,0,1-17-17l80-80a12,12,0,0,1,17,0l80,80A12,12,0,0,1,216.49,168.49Z"></path>`);
var root_3$31 = from_svg(`<path d="M208,160H48l80-80Z" opacity="0.2"></path><path d="M213.66,154.34l-80-80a8,8,0,0,0-11.32,0l-80,80A8,8,0,0,0,48,168H208a8,8,0,0,0,5.66-13.66ZM67.31,152,128,91.31,188.69,152Z"></path>`, 1);
var root_4$24 = from_svg(`<path d="M215.39,163.06A8,8,0,0,1,208,168H48a8,8,0,0,1-5.66-13.66l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,215.39,163.06Z"></path>`);
var root_5$25 = from_svg(`<path d="M212.24,164.24a6,6,0,0,1-8.48,0L128,88.49,52.24,164.24a6,6,0,0,1-8.48-8.48l80-80a6,6,0,0,1,8.48,0l80,80A6,6,0,0,1,212.24,164.24Z"></path>`);
var root_6$22 = from_svg(`<path d="M213.66,165.66a8,8,0,0,1-11.32,0L128,91.31,53.66,165.66a8,8,0,0,1-11.32-11.32l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,213.66,165.66Z"></path>`);
var root_7$21 = from_svg(`<path d="M210.83,162.83a4,4,0,0,1-5.66,0L128,85.66,50.83,162.83a4,4,0,0,1-5.66-5.66l80-80a4,4,0,0,1,5.66,0l80,80A4,4,0,0,1,210.83,162.83Z"></path>`);
var root$52 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function CaretUp($$anchor, $$props) {
	...
	var consequent_3 = ($$anchor) => {
		append($$anchor, root_4$24());
	};
	var consequent_4 = ($$anchor) => {
		append($$anchor, root_5$25());
	};
	var consequent_5 = ($$anchor) => {
		append($$anchor, root_6$22());
	};
	var consequent_6 = ($$anchor) => {
		append($$anchor, root_7$21());
	};
	var alternate = ($$anchor) => {
		var text$36 = text();
...
var root_1$36 = from_html(`<div class="ml-4"><span class="flex items-center before:content-[''] before:inline-block before:w-2 before:h-2 before:rounded-full before:mr-1 before:bg-(--contributor-color) before:border-2 before:border-(--contributor-color) before:align-middle"></span></div>`);
var root$51 = from_html(`<div class="mx-6 mb-2"><h3 class="font-bold"> </h3> <!></div>`);
...
var root_2$44 = from_html(`<a target="_blank" rel="noopener noreferrer" class="flex items-center before:content-[''] before:inline-block before:w-2 before:h-2 before:rounded-full before:mr-1 before:bg-(--contributor-color) before:border-2 before:border-(--contributor-color) before:align-middle"> </a>`);
var root_3$30 = from_html(`<span class="flex items-center before:content-[''] before:inline-block before:w-2 before:h-2 before:rounded-full before:mr-1 before:bg-(--contributor-color) before:border-2 before:border-(--contributor-color) before:align-middle"> </span>`);
var root_1$35 = from_html(`<div class="ml-4"><!></div>`);
var root$50 = from_html(`<div class="mx-6 mb-2"><h3 class="font-bold">Contributors</h3> <!></div>`);
...
var root_4$23 = from_html(` <!>`, 1);
var root_7$20 = from_html(`<!> <!>`, 1);
var root_3$29 = from_html(`<!> <!>`, 1);
...
var root_6$21 = from_html(`<label class="flex items-start gap-2 rounded-lg border border-border p-2 text-sm"><!> <span><span class="block font-medium">Include API key</span></span></label>`);
var root_2$43 = from_html(`<!> <div class="space-y-3"><div class="rounded-lg border border-border bg-muted/30 p-3 text-sm"><h3 class="font-medium">Includes:</h3> <ul class="mt-2 list-disc space-y-0.5 pl-5 text-muted-foreground"><li>User ID and username</li> <li>Client version and database size</li> <li>Export date and time</li> <li>Version notice</li> <li>Preferences</li> <li>Filters and sorting</li> <li>Stakeouts, notes and quick items</li></ul></div> <!> <!></div> <!>`, 1);
...
var root$49 = from_html(`<article class="flex h-full flex-col rounded-lg border border-border p-2"><div class="flex flex-wrap items-center gap-2"><h3 class="text-sm font-bold"> </h3> <!></div> <p class="mt-1 text-sm text-muted-foreground"> </p> <!> <div class="mt-auto pt-2 flex flex-wrap gap-2"><!> <!> <!></div></article> <!> <!>`, 1);
...
var root$48 = from_html(`<input class="hidden" type="file" accept=".json,application/json"/> <!>`, 1);
...
var root_1$34 = from_html(`<p class="text-muted-foreground flex items-center gap-1"><!> Loading sync status...</p>`);
var root_2$40 = from_html(`<p>Last update: <span class="font-medium"> </span></p> <p>Version: <span class="font-medium"> </span></p> <p>Database size: <span class="font-medium"> </span></p>`, 1);
var root_3$25 = from_html(`<p class="text-muted-foreground"> </p>`);
var root$47 = from_html(`<div class="mt-1 text-xs"><!></div>`);
...
var root_5$23 = from_html(`<div class="rounded-lg border border-amber-300 bg-amber-50 p-3 text-sm text-amber-950 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-100"> </div>`);
...
var root$45 = from_html(`<section class="space-y-4"><section class="rounded-lg border border-border bg-card py-2 px-3"><h2 class="text-lg font-bold">Locally</h2> <div class="mt-2 grid gap-2 sm:grid-cols-2"><!> <!></div></section> <section class="rounded-lg border border-border bg-card py-2 px-3"><h2 class="text-lg font-bold">Remote</h2> <div class="mt-2 grid gap-2 sm:grid-cols-2"><!></div></section></section>`);
...
var root_2$39 = from_html(`<li><a class="px-2 py-1 rounded transition-colors hover:bg-gray-100 dark:hover:bg-gray-800"> </a></li>`);
var root_1$33 = from_html(`<div class="flex flex-col min-h-screen"><header class="px-5 py-2 flex items-center justify-center gap-5"><nav><ul class="flex gap-4"></ul></nav> <div class="w-px h-6 bg-gray-300 dark:bg-gray-600"></div> <nav><ul class="flex gap-4"><li><a href="/targets.html" target="_blank" rel="noopener noreferrer" class="px-2 py-1 rounded transition-colors hover:bg-gray-100 dark:hover:bg-gray-800">Targets</a></li></ul></nav></header> <!> <main class="p-8 max-w-5xl mx-auto w-full"><!></main></div>`);
...
var root_2$38 = from_html(`<div><!> <!></div> <!>`, 1);
var root_1$32 = from_html(`<!> <!>`, 1);
...
var root_2$37 = from_svg(`<path d="M228,104a12,12,0,0,1-24,0V69l-59.51,59.51a12,12,0,0,1-17-17L187,52H152a12,12,0,0,1,0-24h64a12,12,0,0,1,12,12Zm-44,24a12,12,0,0,0-12,12v64H52V84h64a12,12,0,0,0,0-24H48A20,20,0,0,0,28,80V208a20,20,0,0,0,20,20H176a20,20,0,0,0,20-20V140A12,12,0,0,0,184,128Z"></path>`);
var root_3$24 = from_svg(`<path d="M184,80V208a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V80a8,8,0,0,1,8-8H176A8,8,0,0,1,184,80Z" opacity="0.2"></path><path d="M224,104a8,8,0,0,1-16,0V59.32l-66.33,66.34a8,8,0,0,1-11.32-11.32L196.68,48H152a8,8,0,0,1,0-16h64a8,8,0,0,1,8,8Zm-40,24a8,8,0,0,0-8,8v72H48V80h72a8,8,0,0,0,0-16H48A16,16,0,0,0,32,80V208a16,16,0,0,0,16,16H176a16,16,0,0,0,16-16V136A8,8,0,0,0,184,128Z"></path>`, 1);
var root_4$21 = from_svg(`<path d="M192,136v72a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V80A16,16,0,0,1,48,64h72a8,8,0,0,1,0,16H48V208H176V136a8,8,0,0,1,16,0Zm32-96a8,8,0,0,0-8-8H152a8,8,0,0,0-5.66,13.66L172.69,72l-42.35,42.34a8,8,0,0,0,11.32,11.32L184,83.31l26.34,26.35A8,8,0,0,0,224,104Z"></path>`);
var root_5$22 = from_svg(`<path d="M222,104a6,6,0,0,1-12,0V54.49l-69.75,69.75a6,6,0,0,1-8.48-8.48L201.51,46H152a6,6,0,0,1,0-12h64a6,6,0,0,1,6,6Zm-38,26a6,6,0,0,0-6,6v72a2,2,0,0,1-2,2H48a2,2,0,0,1-2-2V80a2,2,0,0,1,2-2h72a6,6,0,0,0,0-12H48A14,14,0,0,0,34,80V208a14,14,0,0,0,14,14H176a14,14,0,0,0,14-14V136A6,6,0,0,0,184,130Z"></path>`);
var root_6$19 = from_svg(`<path d="M224,104a8,8,0,0,1-16,0V59.32l-66.33,66.34a8,8,0,0,1-11.32-11.32L196.68,48H152a8,8,0,0,1,0-16h64a8,8,0,0,1,8,8Zm-40,24a8,8,0,0,0-8,8v72H48V80h72a8,8,0,0,0,0-16H48A16,16,0,0,0,32,80V208a16,16,0,0,0,16,16H176a16,16,0,0,0,16-16V136A8,8,0,0,0,184,128Z"></path>`);
var root_7$19 = from_svg(`<path d="M220,104a4,4,0,0,1-8,0V49.66l-73.16,73.17a4,4,0,0,1-5.66-5.66L206.34,44H152a4,4,0,0,1,0-8h64a4,4,0,0,1,4,4Zm-36,28a4,4,0,0,0-4,4v72a4,4,0,0,1-4,4H48a4,4,0,0,1-4-4V80a4,4,0,0,1,4-4h72a4,4,0,0,0,0-8H48A12,12,0,0,0,36,80V208a12,12,0,0,0,12,12H176a12,12,0,0,0,12-12V136A4,4,0,0,0,184,132Z"></path>`);
var root$35 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
function ArrowSquareOutIcon($$anchor, $$props) {
	...
	var node_2 = sibling(node, 2);
	var consequent_1 = ($$anchor) => {
		append($$anchor, root_2$37());
	};
	var consequent_2 = ($$anchor) => {
		var fragment_1 = root_3$24();
		next();
		append($$anchor, fragment_1);
	};
	var consequent_3 = ($$anchor) => {
...
var root_2$36 = from_html(`<!> <!>`, 1);
var root_1$29 = from_html(`<!> <!>`, 1);
...
var root_3$23 = from_html(`<a target="_blank" rel="noreferrer" class="flex items-center gap-1 text-xs text-primary hover:underline"> <!></a>`);
var root_2$35 = from_html(`<div class="flex flex-wrap gap-x-2 gap-y-1 px-1"></div>`);
var root_4$20 = from_html(`<!> <!>`, 1);
var root_1$28 = from_html(`<div class="grid gap-1"><!> <div class="rounded-md border border-border bg-background/60"><!></div> <!></div>`);
...
var root$34 = from_html(`<div class="space-y-2"><!> <!> <!> <!> <!> <!> <!> <!> <!></div>`);
...
var root$33 = from_html(`<section class="rounded-lg border border-border bg-card px-3 py-2"><h2 class="text-lg font-bold">Not Found - Section</h2> <p class="mt-1 text-sm text-muted-foreground">Couldn't find your requested preferences section in this group.</p></section>`);
...
var root_1$27 = from_html(`<h3> </h3>`);
var root_2$34 = from_html(`<p class="text-xs text-muted-foreground"> </p>`);
var root$32 = from_html(`<div class="rounded-md border border-border bg-background/60 p-2"><div class="mb-1"><!> <!></div> <div><!></div></div>`);
...
var root_1$26 = from_html(`<span class="absolute end-2 flex size-3.5 items-center justify-center"><!></span> <!>`, 1);
...
var root_5$21 = from_html(`<img class="w-6"/>`);
var root_2$31 = from_html(`<span class="text-[10px] uppercase">Requires</span> <span class="flex gap-1"></span>`, 1);
...
var root_3$22 = from_html(` <!>`, 1);
var root_2$30 = from_html(`<div class="flex flex-wrap items-center gap-2"><!> <!></div> <!>`, 1);
var root_1$21 = from_html(`<!> <!>`, 1);
var root_7$18 = from_html(`<div class="grid gap-1 bg-muted/50 p-2"><!></div>`);
var root$30 = from_html(`<div><!> <!></div>`);
function StorageSwitch($$anchor, $$props) {
	...
	component(node, () => Field, ($$anchor, Field_Field) => {
		Field_Field($$anchor, {
			...
			class: "p-2",
			children: ($$anchor, $$slotProps) => {
				var fragment = root_1$21();
				var node_1 = first_child(fragment);
				component(node_1, () => Field_content, ($$anchor, Field_Content) => {
					Field_Content($$anchor, {
						children: ($$anchor, $$slotProps) => {
							var fragment_1 = root_2$30();
...
var root_2$29 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_4$19 = from_html(`<!> <!>`, 1);
var root_6$18 = from_html(`<!> <!> <!> <!>`, 1);
var root$29 = from_html(`<div class="space-y-2"><!> <!> <!></div>`);
...
var root_2$28 = from_html(`<!> <!> <!> <!>`, 1);
var root_5$20 = from_html(`<!> <!> <!>`, 1);
var root_10$4 = from_html(`<!> <!>`, 1);
var root_9$5 = from_html(`<!> <!>`, 1);
var root_8$8 = from_html(`<!> <!> <!> <!>`, 1);
var root$28 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
...
var root_5$19 = from_html(`<!> <!>`, 1);
var root_7$17 = from_html(`<!> <!> <!>`, 1);
var root_11$4 = from_html(`<!> <!>`, 1);
var root_10$3 = from_html(`<div class="rounded-md border border-border bg-background/60"><!></div>`);
var root_14$2 = from_html(`<p class="text-sm text-amber-600 dark:text-amber-400">Requires API data to be loaded.</p>`);
var root_6$17 = from_html(`<div class="grid gap-2"><!> <!></div>`);
...
var root_1$19 = from_html(`<div class="grid gap-1"><!></div>`);
from_html(`<!> <span class="text-muted-foreground m-1 inline-block text-xs">Sometimes it might be necessary for us to collect information about very specific issues. These might share sensitive
			in-game information (like money on hand) with the developers. You should only enable these whenever asked by a
			developer to help them gather the information we need.</span> <div class="grid gap-1"></div>`, 1);
var root$26 = from_html(`<!> <!>`, 1);
...
var root_4$18 = from_html(`<li> </li>`);
var root_6$16 = from_html(`<div class="rounded-md border border-border bg-background/60 p-2"><div class="grid gap-2 md:grid-cols-[1fr_40px_28px]"><!> <!> <!></div></div>`);
var root_5$17 = from_html(`<div class="space-y-1"></div>`);
var root_8$7 = from_html(`<p class="rounded-md border border-dashed border-border p-2 text-center text-muted-foreground">No highlights configured.</p>`);
...
var root_5$16 = from_html(`<div class="rounded-md border border-border bg-background/60 p-2"><div class="grid gap-2 md:grid-cols-[repeat(2,1fr)_28px]"><!> <!> <!></div></div>`);
var root_4$17 = from_html(`<div class="space-y-1"></div>`);
var root_7$16 = from_html(`<p class="rounded-md border border-dashed border-border p-2 text-center text-muted-foreground">No colored chats configured.</p>`);
...
var root$24 = from_html(`<span class="ml-2 mb-1 text-muted-foreground text-xs"> </span>`);
...
var root_5$15 = from_html(`<div class="rounded-md border border-border bg-background/60 p-2"><div class="grid gap-2 md:grid-cols-[8rem_1fr_1fr_28px]"><!> <!> <!> <!></div></div>`);
var root_7$15 = from_html(`<div class="rounded-md border border-border bg-background/60 p-2"><div class="grid gap-2 md:grid-cols-[8rem_1fr_1fr_28px]"><!> <!> <!> <!></div></div>`);
...
var root_5$14 = from_html(`<!> <!> <!>`, 1);
var root_1$16 = from_html(`<!> <!> <!> <!>`, 1);
var root$23 = from_html(`<div class="space-y-2"><!> <!></div>`);
...
var root_2$22 = from_svg(`<path d="M208.49,152.49l-72,72a12,12,0,0,1-17,0l-72-72a12,12,0,0,1,17-17L116,187V40a12,12,0,0,1,24,0V187l51.51-51.52a12,12,0,0,1,17,17Z"></path>`);
...
var root_4$15 = from_svg(`<path d="M205.66,149.66l-72,72a8,8,0,0,1-11.32,0l-72-72A8,8,0,0,1,56,136h64V40a8,8,0,0,1,16,0v96h64a8,8,0,0,1,5.66,13.66Z"></path>`);
var root_5$13 = from_svg(`<path d="M204.24,148.24l-72,72a6,6,0,0,1-8.48,0l-72-72a6,6,0,0,1,8.48-8.48L122,201.51V40a6,6,0,0,1,12,0V201.51l61.76-61.75a6,6,0,0,1,8.48,8.48Z"></path>`);
var root_6$15 = from_svg(`<path d="M205.66,149.66l-72,72a8,8,0,0,1-11.32,0l-72-72a8,8,0,0,1,11.32-11.32L120,196.69V40a8,8,0,0,1,16,0V196.69l58.34-58.35a8,8,0,0,1,11.32,11.32Z"></path>`);
var root_7$14 = from_svg(`<path d="M202.83,146.83l-72,72a4,4,0,0,1-5.66,0l-72-72a4,4,0,0,1,5.66-5.66L124,206.34V40a4,4,0,0,1,8,0V206.34l65.17-65.17a4,4,0,0,1,5.66,5.66Z"></path>`);
var root$22 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
...
var root_2$21 = from_svg(`<path d="M208.49,120.49a12,12,0,0,1-17,0L140,69V216a12,12,0,0,1-24,0V69L64.49,120.49a12,12,0,0,1-17-17l72-72a12,12,0,0,1,17,0l72,72A12,12,0,0,1,208.49,120.49Z"></path>`);
...
var root_4$14 = from_svg(`<path d="M207.39,115.06A8,8,0,0,1,200,120H136v96a8,8,0,0,1-16,0V120H56a8,8,0,0,1-5.66-13.66l72-72a8,8,0,0,1,11.32,0l72,72A8,8,0,0,1,207.39,115.06Z"></path>`);
var root_5$12 = from_svg(`<path d="M204.24,116.24a6,6,0,0,1-8.48,0L134,54.49V216a6,6,0,0,1-12,0V54.49L60.24,116.24a6,6,0,0,1-8.48-8.48l72-72a6,6,0,0,1,8.48,0l72,72A6,6,0,0,1,204.24,116.24Z"></path>`);
var root_6$14 = from_svg(`<path d="M205.66,117.66a8,8,0,0,1-11.32,0L136,59.31V216a8,8,0,0,1-16,0V59.31L61.66,117.66a8,8,0,0,1-11.32-11.32l72-72a8,8,0,0,1,11.32,0l72,72A8,8,0,0,1,205.66,117.66Z"></path>`);
var root_7$13 = from_svg(`<path d="M202.83,114.83a4,4,0,0,1-5.66,0L132,49.66V216a4,4,0,0,1-8,0V49.66L58.83,114.83a4,4,0,0,1-5.66-5.66l72-72a4,4,0,0,1,5.66,0l72,72A4,4,0,0,1,202.83,114.83Z"></path>`);
...
var root_5$11 = from_html(`<div class="rounded-md border border-border bg-background/60 p-2"><div class="grid gap-2 lg:grid-cols-[12rem_15rem_1fr]"><!> <!> <!></div> <!> <div class="mt-2 flex flex-wrap gap-1.5"><!> <!> <!> <div class="flex items-center w-full max-w-sm gap-1.5"><!> <!></div></div></div>`);
...
var root$20 = from_html(`<span class="icon svelte-zigx8g"></span>`);
...
var root_2$20 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_5$10 = from_html(`<!> <!>`, 1);
var root_4$12 = from_html(`<!> <!> <!> <!> <!> <!>`, 1);
var root_6$13 = from_html(`<!> <!> <!> <!> <!>`, 1);
var root_7$12 = from_html(`<!> <!>`, 1);
var root_1$15 = from_html(`<div class="grid gap-1"><!> <!> <!> <!></div>`);
var root_12$3 = from_html(`<!> <!>`, 1);
var root_10$2 = from_html(`<div class="flex flex-wrap gap-1"></div>`);
...
var root_6$12 = from_html(`<div class="grid gap-2 rounded-md border border-border bg-background/60 p-2 md:grid-cols-[minmax(0,1fr)_5rem_6rem_auto]"><!> <!> <!> <!></div>`);
var root_5$8 = from_html(`<div class="space-y-1"></div>`);
var root_8$6 = from_html(`<p class="rounded-md border border-dashed border-border p-2 text-center text-xs text-muted-foreground">No NPC alerts configured.</p>`);
...
var root_1$11 = from_html(`<span data-slot="slider-track"><!></span> <!>`, 1);
...
var root_2$17 = from_svg(`<path d="M234.49,111.07,90.41,22.94A20,20,0,0,0,60,39.87V216.13a20,20,0,0,0,30.41,16.93l144.08-88.13a19.82,19.82,0,0,0,0-33.86ZM84,208.85V47.15L216.16,128Z"></path>`);
...
var root_4$11 = from_svg(`<path d="M240,128a15.74,15.74,0,0,1-7.6,13.51L88.32,229.65a16,16,0,0,1-16.2.3A15.86,15.86,0,0,1,64,216.13V39.87a15.86,15.86,0,0,1,8.12-13.82,16,16,0,0,1,16.2.3L232.4,114.49A15.74,15.74,0,0,1,240,128Z"></path>`);
var root_5$7 = from_svg(`<path d="M231.36,116.19,87.28,28.06a14,14,0,0,0-14.18-.27A13.69,13.69,0,0,0,66,39.87V216.13a13.69,13.69,0,0,0,7.1,12.08,14,14,0,0,0,14.18-.27l144.08-88.13a13.82,13.82,0,0,0,0-23.62Zm-6.26,13.38L81,217.7a2,2,0,0,1-2.06,0,1.78,1.78,0,0,1-1-1.61V39.87a1.78,1.78,0,0,1,1-1.61A2.06,2.06,0,0,1,80,38a2,2,0,0,1,1,.31L225.1,126.43a1.82,1.82,0,0,1,0,3.14Z"></path>`);
var root_6$11 = from_svg(`<path d="M232.4,114.49,88.32,26.35a16,16,0,0,0-16.2-.3A15.86,15.86,0,0,0,64,39.87V216.13A15.94,15.94,0,0,0,80,232a16.07,16.07,0,0,0,8.36-2.35L232.4,141.51a15.81,15.81,0,0,0,0-27ZM80,215.94V40l143.83,88Z"></path>`);
var root_7$11 = from_svg(`<path d="M230.32,117.9,86.24,29.79a11.91,11.91,0,0,0-12.17-.23A11.71,11.71,0,0,0,68,39.89V216.11a11.71,11.71,0,0,0,6.07,10.33,11.91,11.91,0,0,0,12.17-.23L230.32,138.1a11.82,11.82,0,0,0,0-20.2Zm-4.18,13.37L82.06,219.39a4,4,0,0,1-4.07.07,3.77,3.77,0,0,1-2-3.35V39.89a3.77,3.77,0,0,1,2-3.35,4,4,0,0,1,4.07.07l144.08,88.12a3.8,3.8,0,0,1,0,6.54Z"></path>`);
var root$17 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
...
var root_2$16 = from_svg(`<path d="M200,36H56A20,20,0,0,0,36,56V200a20,20,0,0,0,20,20H200a20,20,0,0,0,20-20V56A20,20,0,0,0,200,36Zm-4,160H60V60H196Z"></path>`);
...
var root_4$10 = from_svg(`<path d="M216,56V200a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V56A16,16,0,0,1,56,40H200A16,16,0,0,1,216,56Z"></path>`);
var root_5$6 = from_svg(`<path d="M200,42H56A14,14,0,0,0,42,56V200a14,14,0,0,0,14,14H200a14,14,0,0,0,14-14V56A14,14,0,0,0,200,42Zm2,158a2,2,0,0,1-2,2H56a2,2,0,0,1-2-2V56a2,2,0,0,1,2-2H200a2,2,0,0,1,2,2Z"></path>`);
var root_6$10 = from_svg(`<path d="M200,40H56A16,16,0,0,0,40,56V200a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Zm0,160H56V56H200V200Z"></path>`);
var root_7$10 = from_svg(`<path d="M200,44H56A12,12,0,0,0,44,56V200a12,12,0,0,0,12,12H200a12,12,0,0,0,12-12V56A12,12,0,0,0,200,44Zm4,156a4,4,0,0,1-4,4H56a4,4,0,0,1-4-4V56a4,4,0,0,1,4-4H200a4,4,0,0,1,4,4Z"></path>`);
...
var root_1$10 = from_html(`<div class="grid gap-1 grid-cols-2"><!> <!> <!> <!></div>`);
...
var root_1$8 = from_html(`<div class="grid gap-1"><!> <!> <!></div>`);
...
var root_2$13 = from_html(`<div class="grid gap-1"><!> <!> <!> <!> <!></div>`);
var root$15 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
...
var root_2$11 = from_svg(`<path d="M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm0,192a84,84,0,1,1,84-84A84.09,84.09,0,0,1,128,212Z"></path>`);
...
var root_4$8 = from_svg(`<path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>`);
var root_5$5 = from_svg(`<path d="M128,26A102,102,0,1,0,230,128,102.12,102.12,0,0,0,128,26Zm0,192a90,90,0,1,1,90-90A90.1,90.1,0,0,1,128,218Z"></path>`);
var root_6$8 = from_svg(`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Z"></path>`);
var root_7$8 = from_svg(`<path d="M128,28A100,100,0,1,0,228,128,100.11,100.11,0,0,0,128,28Zm0,192a92,92,0,1,1,92-92A92.1,92.1,0,0,1,128,220Z"></path>`);
var root$13 = from_svg(`<svg><!><rect width="256" height="256" fill="none"></rect><!></svg>`);
...
var root_1$6 = from_html(`<div data-slot="radio-group-indicator" class="flex size-4 items-center justify-center"><!></div>`);
...
var root_4$7 = from_html(`<p class="text-xs text-muted-foreground"> </p>`);
var root_3$6 = from_html(`<span class="block font-medium"> </span> <!>`, 1);
var root_2$10 = from_html(`<div class="flex items-center gap-2 rounded-sm border border-border px-2 py-1.5"><!> <!></div>`);
var root$12 = from_html(`<section class="rounded-lg border border-border bg-card px-3 py-2"><div class="space-y-3"><h3 class="text-sm font-semibold">Page Theme</h3> <!></div></section>`);
...
var root_6$7 = from_html(`<div class="grid gap-2 rounded-md border border-border bg-background/60 p-2 md:grid-cols-[1fr_28px]"><!> <!></div>`);
var root_8$4 = from_html(`<div class="grid gap-2 rounded-md border border-border bg-background/60 p-2 md:grid-cols-[1fr_28px]"><!> <!></div>`);
var root_5$4 = from_html(`<!> <!>`, 1);
var root_10$1 = from_html(`<div class="rounded-md border border-dashed border-border p-2 text-center text-muted-foreground">No allied factions configured.</div>`);
...
var root_6$6 = from_html(`<div class="rounded-md border border-border bg-background/60"><!></div>`);
var root_3$4 = from_html(`<div class="grid gap-2"><!> <!></div>`);
var root_11$2 = from_html(`<!> <!> <!> <!>`, 1);
var root_12$2 = from_html(`<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>`, 1);
var root_10 = from_html(`<div class="grid gap-1"><!> <!> <!></div>`);
var root$11 = from_html(`<div class="space-y-2"><!> <!> <!> <!></div>`);
...
var root_7$6 = from_html(`<div class="grid gap-2 rounded-md border border-border bg-background/60 p-2 md:grid-cols-[1fr_3rem_28px]"><!> <!> <!></div>`);
var root_6$5 = from_html(`<div class="space-y-1"></div>`);
...
var root_8$3 = from_html(`<div class="grid grid-cols-[1fr_auto_auto] items-center gap-1 rounded-md border border-border bg-background/60 p-2"><span class="text-sm"> </span> <div class="flex justify-center w-18"><!></div> <!></div>`);
var root_4$3 = from_html(`<!> <div class="space-y-1"><div class="grid grid-cols-[1fr_auto_auto] items-center gap-1 text-sm text-muted-foreground"><span>Service</span> <span class="text-center w-18">Enabled</span> <span class="text-center w-18">Priority</span></div> <!></div>`, 1);
										...
										component(sibling(node_4, 2), () => Dialog_description, ($$anchor, Dialog_Description) => {
											Dialog_Description($$anchor, {
												children: ($$anchor, $$slotProps) => {
													next();
													var text_1 = text();
													template_effect(($0) => set_text(text_1, `Configure your service preferences for ${$0 ?? ""} here. Lowest priority goes first.
                Services with the same priority will run at the same time and will compete for the ${usesBest() ? "best" : "fastest"} response.`), [() => $$props.title.toLowerCase()]);
													append($$anchor, text_1);
												},
												$$slots: { default: true }
											});
...
var root_5$1 = from_html(`<div class="grid gap-2"><!> <!> <!></div>`);
var root_12$1 = from_html(`<div class="grid gap-2 rounded-md border border-border bg-background/60 p-2 md:grid-cols-[1fr_3rem_28px]"><!> <!> <!></div>`);
var root_11$1 = from_html(`<div class="space-y-1"></div>`);
var root_14 = from_html(`<p class="rounded-md border border-dashed border-border p-2 text-center text-muted-foreground">No inactivity warnings configured.</p>`);
...
var root_23 = from_html(`<a href="https://www.torn.com/forums.php#/p=threads&amp;f=61&amp;t=16192039" target="_blank" rel="noreferrer" class="flex items-center gap-1 text-xs text-primary hover:underline">Score formula <!></a>`);
...
var root_7$2 = from_html(`<section class="rounded-lg border border-border bg-card px-3 py-2"><h2 class="text-lg font-bold">Not Found - Group</h2> <p class="mt-1 text-sm text-muted-foreground">Couldn't find your requested preferences group.</p></section>`);
...
var PREFERENCE_SEARCH_DATA = [
	...
	{
		path: "settings.scripts.noConfirm.abroadItemBuy",
		label: "No confirm: Buying items aboard",
		group: "qol",
		section: "speed"
	},
	{
...
var root_13 = from_html(`<span class="truncate text-xs text-muted-foreground"> </span>`);
var root_12 = from_html(`<div><span class="truncate text-sm"> </span> <!></div>`);
...
var root_1$1 = from_html(`<!> <span class="flex-1">Search</span> <!>`, 1);
var root_4 = from_html(`<div><a> </a></div>`);
var root$3 = from_html(`<aside class="rounded-lg border border-sidebar bg-sidebar p-2 space-y-1 flex flex-col"><!> <div class="space-y-1"></div></aside> <!>`, 1);
...
var root$1 = from_html(`<section class="grid gap-2 lg:grid-cols-[11rem_1fr]"><!> <div class="space-y-2"><!> <!></div></section>`);
...
//# sourceMappingURL=options-Df9JTO5p.js.map