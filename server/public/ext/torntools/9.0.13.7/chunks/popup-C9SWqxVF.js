import { $ as set_class, At as template_effect, Bt as set, Et as get, Ft as child, G as init, Gt as setup_stores, H as prop, It as first_child, K as bind_this, Kt as store_get, Lt as sibling, Q as set_style, Qt as push, Rt as proxy, U as rest_props, Ut as user_derived, V as onMount, Vt as state, X as attribute_effect, Z as set_attribute, Zt as pop, _t as from_svg, a as BACKGROUND_SERVICE, at as snippet, c as cn, ct as index, dt as mount, et as clsx, ft as set_text, gt as from_html, ht as comment, i as exposeDebugObjects, it as component, jt as user_effect, m as loadDatabase, mt as append, n as setMode, nn as reset, nt as action, p as initializeDatabase, qt as writable, rn as noop, rt as element, st as each, t as Mode_watcher, tn as next, ut as if_block, v as storageListeners, w as ttCache, yt as text, z as ttStorage } from "./dist-_zJwT7ZA.js";
import { A as browser, b as isHTMLElement, d as isToday, p as sleep, r as TO_MILLIS } from "./utilities-B1TyU249.js";
import { Ht as formatNumber, It as applyPlural, Kt as Router, Lt as capitalizeText, Ut as formatTime, Vt as formatDate, Wt as toSeconds, Xt as router, Yt as replace, _ as tv, a as Tooltip_trigger, c as Tooltip, d as Badge, h as Button, i as active, l as Sonner_1, m as getIconContext, n as Input, o as Tooltip_provider, qt as link, r as registerExtensionContext, s as Tooltip_content, t as TrashIcon, v as Separator, zt as dropDecimals } from "./TrashIcon-CpHrnLBj.js";
import { B as getRewardValue, G as isSellable, H as getStockIncrement, I as LINKS, R as getNextChainBonus, U as getStockReward, V as getStockBoughtPrice, W as isDividendStock, _ as Card_content, a as Input_group_input, b as fetchData, c as Command_group, d as MagnifyingGlassIcon, f as changeAPIKey, g as Card_description, h as Card_header, i as Command_input, j as ALL_ICONS, k as Spinner, l as Command_empty, m as Card_title, n as Command_list, o as Input_group_addon, p as checkAPIPermission, r as Command_item, s as Input_group, t as Command_shortcut, u as Command, v as Card, z as getRequiredStocks } from "./command-t-Zfmthh.js";
import { t as CaretDownIcon } from "./CaretDownIcon-CGqP2Wu-.js";
import { a as Table_body, i as Table_cell, n as Table_header, o as Table, r as Table_head, t as Table_row } from "./table-CMsToL_e.js";
...
var root_7$7 = from_html(`<label class="truncate text-xs"> </label> <!>`, 1);
...
var root_4$9 = from_html(`<div class="grid grid-cols-[64px_1fr_auto] gap-1"><span> </span> <span class="truncate"> </span> <span> </span></div>`);
var root_5$10 = from_html(`<div class="text-muted-foreground">No items selected.</div>`);
var root_6$7 = from_html(`<!> <div class="flex justify-between gap-1"><!> <div class="text-right font-bold"> </div></div>`, 1);
...
var root$21 = from_html(`<div class="space-y-2 min-h-72"><!> <!></div>`);
...
var root_4$8 = from_html(`<a class="block space-y-1" target="_blank" rel="noreferrer"><div class="flex items-center justify-between text-xs"><span class="font-medium"> </span> <span class="text-foreground/80"> </span></div> <div class="h-1.5 overflow-hidden rounded-sm bg-muted"><div></div></div> <div class="flex justify-between gap-2 text-xs leading-none text-foreground/80"><span> </span> <span class="truncate text-right"> </span></div></a>`);
var root_5$9 = from_html(`<div class="text-xs text-foreground/80">No bar data available.</div>`);
...
var root_2$8 = from_html(`<a class="rounded-lg bg-card border border-border/70 p-1 text-center text-xs hover:bg-muted" target="_blank" rel="noreferrer"><div> </div> <div class="text-foreground/80"> </div></a>`);
...
var root_4$7 = from_svg(`<path d="M221.8,175.94C216.25,166.38,208,139.33,208,104a80,80,0,1,0-160,0c0,35.34-8.26,62.38-13.81,71.94A16,16,0,0,0,48,200H88.81a40,40,0,0,0,78.38,0H208a16,16,0,0,0,13.8-24.06ZM128,216a24,24,0,0,1-22.62-16h45.24A24,24,0,0,1,128,216Z"></path>`);
var root_5$8 = from_svg(`<path d="M220.07,176.94C214.41,167.2,206,139.73,206,104a78,78,0,1,0-156,0c0,35.74-8.42,63.2-14.08,72.94A14,14,0,0,0,48,198H90.48a38,38,0,0,0,75,0H208a14,14,0,0,0,12.06-21.06ZM128,218a26,26,0,0,1-25.29-20h50.58A26,26,0,0,1,128,218Zm81.71-33a1.9,1.9,0,0,1-1.7,1H48a1.9,1.9,0,0,1-1.7-1,2,2,0,0,1,0-2C53.87,170,62,139.69,62,104a66,66,0,1,1,132,0c0,35.68,8.14,65.95,15.71,79A2,2,0,0,1,209.71,185Z"></path>`);
var root_6$6 = from_svg(`<path d="M221.8,175.94C216.25,166.38,208,139.33,208,104a80,80,0,1,0-160,0c0,35.34-8.26,62.38-13.81,71.94A16,16,0,0,0,48,200H88.81a40,40,0,0,0,78.38,0H208a16,16,0,0,0,13.8-24.06ZM128,216a24,24,0,0,1-22.62-16h45.24A24,24,0,0,1,128,216ZM48,184c7.7-13.24,16-43.92,16-80a64,64,0,1,1,128,0c0,36.05,8.28,66.73,16,80Z"></path>`);
var root_7$6 = from_svg(`<path d="M218.35,178C212.58,168,204,140.13,204,104a76,76,0,1,0-152,0c0,36.13-8.59,64-14.36,73.95A12,12,0,0,0,48,196H92.23a36,36,0,0,0,71.54,0H208A12,12,0,0,0,218.35,178ZM128,220a28,28,0,0,1-27.71-24h55.42A28,28,0,0,1,128,220Zm83.45-34a3.91,3.91,0,0,1-3.44,2H48a3.91,3.91,0,0,1-3.44-2,4,4,0,0,1,0-4C52,169.17,60,139.32,60,104a68,68,0,1,1,136,0c0,35.31,8,65.17,15.44,78A4,4,0,0,1,211.45,186Z"></path>`);
...
var root$18 = from_html(`<div class="grid grid-cols-3 gap-1"></div> <div class="flex items-center justify-between text-xs text-foreground/80"><div class="flex items-center gap-1"><span>Updated</span> <span class="font-medium text-foreground"> </span></div> <!></div>`, 1);
...
var root_2$5 = from_svg(`<path d="M184.49,136.49l-80,80a12,12,0,0,1-17-17L159,128,87.51,56.49a12,12,0,1,1,17-17l80,80A12,12,0,0,1,184.49,136.49Z"></path>`);
var root_3$7 = from_svg(`<path d="M176,128,96,208V48Z" opacity="0.2"></path><path d="M181.66,122.34l-80-80A8,8,0,0,0,88,48V208a8,8,0,0,0,13.66,5.66l80-80A8,8,0,0,0,181.66,122.34ZM104,188.69V67.31L164.69,128Z"></path>`, 1);
var root_4$5 = from_svg(`<path d="M181.66,133.66l-80,80A8,8,0,0,1,88,208V48a8,8,0,0,1,13.66-5.66l80,80A8,8,0,0,1,181.66,133.66Z"></path>`);
var root_5$6 = from_svg(`<path d="M180.24,132.24l-80,80a6,6,0,0,1-8.48-8.48L167.51,128,91.76,52.24a6,6,0,0,1,8.48-8.48l80,80A6,6,0,0,1,180.24,132.24Z"></path>`);
var root_6$4 = from_svg(`<path d="M181.66,133.66l-80,80a8,8,0,0,1-11.32-11.32L164.69,128,90.34,53.66a8,8,0,0,1,11.32-11.32l80,80A8,8,0,0,1,181.66,133.66Z"></path>`);
var root_7$4 = from_svg(`<path d="M178.83,130.83l-80,80a4,4,0,0,1-5.66-5.66L170.34,128,93.17,50.83a4,4,0,0,1,5.66-5.66l80,80A4,4,0,0,1,178.83,130.83Z"></path>`);
...
var root_6$3 = from_html(`<div class="rounded-lg border bg-card p-2 text-xs"><div class="flex items-center gap-2"><a class="-m-1 grid min-w-0 flex-1 grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-1 rounded-md p-1 hover:bg-muted/60" target="_blank" rel="noreferrer"><span class="truncate font-medium"> </span> <!></a> <!></div></div>`);
...
var root_3$6 = from_html(`<a class="hover:underline" target="_blank" rel="noreferrer"> </a> <!>`, 1);
...
var root$16 = from_html(`<div class="rounded-lg border bg-card p-2 text-xs"><div class="flex items-start gap-2"><a class="-m-1 block min-w-0 flex-1 rounded-md p-1 hover:bg-muted/60" target="_blank" rel="noreferrer"><div class="flex items-center gap-1.5"><span></span> <span class="truncate font-medium"> </span> <!></div> <div class="mt-1 grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 text-[10px] text-foreground/80"><span>Life</span> <div class="h-1.5 flex-1 overflow-hidden rounded-sm bg-muted"><div class="h-full bg-blue-500"></div></div> <span> </span></div> <div class="mt-1 flex items-center justify-between gap-2"><span> </span> <span class="shrink-0 text-foreground/80"> </span></div></a> <!></div></div>`);
...
var root_5$4 = from_html(`<div class="space-y-1"></div>`);
...
var root_2$4 = from_html(`<div class="border-b border-destructive/30 bg-destructive/10 px-3 py-2 text-xs text-destructive"> </div>`);
var root_5$3 = from_html(`<a class="rounded-sm px-1 py-0.5 text-xs transition-colors hover:bg-accent hover:text-accent-foreground whitespace-nowrap"> </a>`);
var root_3$5 = from_html(`<div class="border-b border-border p-1"><nav class="flex items-center gap-1 overflow-x-auto"><!> <!></nav></div>`);
var root_1$6 = from_html(`<div class="min-h-60 bg-background text-foreground"><!> <!> <main class="overflow-y-auto p-3"><!></main></div>`);
var root$14 = from_html(`<!> <!> <!>`, 1);
...
var root_3$4 = from_html(`Welcome to Torn<span class="text-primary">Tools</span>`, 1);
var root_5$2 = from_html(`<div class="rounded-md border border-destructive/30 bg-destructive/10 px-2 py-1.5 text-xs text-destructive"> </div>`);
var root_6$2 = from_html(`<div class="rounded-md border border-amber-500/30 bg-amber-500/10 px-2 py-1.5 text-xs text-amber-700 dark:text-amber-300"> </div>`);
var root_4$3 = from_html(`<div class="space-y-1.5"><label for="api-key" class="text-xs font-medium">Please enter your API key:</label> <!></div> <!> <!> <div class="flex gap-2"><!> <!></div> <div class="text-xs text-muted-foreground">TornTools needs a <span class="text-amber-600 dark:text-amber-300">Limited Access</span> key.</div> <!> <a class="block text-xs text-muted-foreground hover:text-foreground" target="_blank" rel="noreferrer">Terms of Service</a>`, 1);
...
var root_7$2 = from_html(`<span> </span> <!>`, 1);
...
var root$13 = from_html(`<section class="space-y-1"><h2 class="text-xs font-bold"> </h2> <!></section>`);
...
var root_7$1 = from_html(`<img class="size-16 rounded-md border border-border object-contain"/> <div class="min-w-0 space-y-1"><!> <!> <div class="grid grid-cols-2 gap-2 pt-1 text-xs"><div><div class="text-muted-foreground">Circulation</div> <div> </div></div> <div><div class="text-muted-foreground">Market value</div> <div> </div></div></div></div>`, 1);
...
var root_2$2 = from_html(`<a target="_blank" rel="noreferrer"><div class="flex justify-between"><span class="text-foreground font-bold"> </span> <span class="text-muted-foreground"><!></span></div> <div class="text-muted-foreground"> </div></a>`);
...
var root_2$1 = from_html(`<div class="text-sm text-muted-foreground">No notification history.</div>`);
...
var root$5 = from_html(`<div class="p-3 text-sm text-muted-foreground">Loading...</div>`);
...
//# sourceMappingURL=popup-C9SWqxVF.js.map