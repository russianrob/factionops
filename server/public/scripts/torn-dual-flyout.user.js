...
(function () {
  ...
  // Bottom edge (viewport px) of the top header/icon bar; gestures starting above
  // this are ignored so the top icon row doesn't trigger the menu. 0 if no header.
  ...
  function onStart(e) {
    ...
    var t = e.touches[0];
    if (t.clientY <= headerBottom()) { start = null; return; }
