...
- **No auto-clicking Torn UI controls.** No programmatic clicks on Next / pagination / tabs / attack / use / bid buttons. Breaks Torn's rules and risks bans. Add your own UI for the user to click instead. Reading the DOM passively is fine.
