...
const mutants = [
  ...
  ["a year back is 365 days, which is a day out after a leap year",
    "    d.setUTCFullYear(d.getUTCFullYear() - 1);", "    return d.getTime() - 365 * 86400000;\n    d.setUTCFullYear(d.getUTCFullYear() - 1);", [U]],
